...
### Components
#### Added
* Added: Date picker now supports change the format time from 12h to 24h when `mode=datetime` is active.
...
* Fixed: Data table select all and deselect all console errors when checkboxes are loaded dinamically.
### Documentation
#### Added
