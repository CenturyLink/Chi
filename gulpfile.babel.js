...
const requires = {
  ...
  'build-portalrebrand24-styles': require('./tasks/build-portalrebrand24-styles.js'),
  'build-lumenrebrand24-styles': require('./tasks/build-lumenrebrand24-styles.js'),
  ...
  'update-dist-files': require('./tasks/update-dist-files'),
};
