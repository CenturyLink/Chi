...
const requires = {
  ...
  'build-portal-rebrand24-styles': require('./tasks/build-portal-rebrand24-styles.js'),
  'build-lumen-rebrand24-styles': require('./tasks/build-lumen-rebrand24-styles.js'),
