...
export const TEMP_DEVELOPMENT_FALLBACK_URL = `https://lib.lumen.com/chi/${CHI_VERSION}`;
...
export const THEMES = {
  ...
  lumenRebrand24: {
    ...
    favicon: '',
    css: `chi-lumen-rebrand24.css`,
    docsCss: `assets/themes/lumen-rebrand24/docs.css`,
  },
  portal: {
  ...
  portaRebrand24: {
    ...
    favicon: '',
    css: `chi-portal-rebrand24.css`,
    docsCss: `assets/themes/portal-rebrand24/docs.css`,
  },
  brightspeed: {
    label: 'Brightspeed',
    favicon: '',
