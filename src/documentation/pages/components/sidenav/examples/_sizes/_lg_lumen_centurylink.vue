<template lang="pug">
  <ComponentExample title="-lg" id="lg-size-lumen-centurylink" :tabs="exampleTabs" padding="-p--0">
    .-d--flex.-overflow--hidden(slot="example")
      aside.chi-sidenav.-flex--shrink0.-animated.-lg(ref="sidenav")
        ...
        .chi-sidenav__drawers
          .chi-drawer.-animated.-left(v-for="val1 in menuItems" :id="`drawer-5-${val1}`")
            .chi-drawer__header
            ...
            .chi-drawer__content
              .chi-accordion
                .chi-accordion__item(v-for="val2 in drawerMenuItems" :class="val1 === activeMenuItem && val2 === activeDrawerMenuItem ? '-active -expanded' : ''")
                  button.chi-accordion__trigger
                    .chi-accordion__title Item {{val2}}
                    i.chi-icon.icon-chevron-down(aria-hidden="true")
                  .chi-accordion__content
                    .chi-accordion
                      .chi-accordion__item(v-for="val3 in drawerMenuItems" :class="`${val1 === activeMenuItem && val2 === activeDrawerMenuItem && val3 === activeDrawerMenuItem ? '-active -expanded' : ''}`")
                        button.chi-accordion__trigger
...
@Component({
  data: () => {
    return {
      ...
      codeSnippets: {
        webcomponent: ``,
        htmlblueprint: `<aside class="chi-sidenav -lg" id="sidenav-5">
...
export default class LgSizeLumenCenturyLink extends Vue {
  mounted() {
