<template lang="pug">
  <ComponentExample title="Background Icons" id="background-icons-portal" :tabs="exampleTabs">
    <Wrapper slot="example">
      ...
      chi-popover(v-for="index in stats.length-1" :key="index" :ref="`popover-${index}`" aria-modal="true" position="bottom" role="dialog" :reference="`#button-bg-icons-portal-${index}`")
