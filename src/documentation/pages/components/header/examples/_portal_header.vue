<template lang="pug">
  <ComponentExample title="Portal Header" id="portal_header_lumen_centurylink" padding=" " :tabs="exampleTabs">
    div(slot="example")
          ...
          nav.chi-header__content
            ...
            .chi-header__start
              ...
              .chi-dropdown.-d--none.-d-lg--flex
                button.chi-button.-flat.chi-dropdown__trigger.-text--xl.-px--1.-animate(id="button-site-menu2") App Name
            ...
            .chi-header__end
              div.-d--none.-d-lg--flex
                button.chi-button.-flat.-icon(id="button-notification" aria-label="Notifications" data-tooltip="Notifications" data-position="bottom")
                  .chi-button__content
                    i.chi-icon.icon-bell-outline(aria-hidden="true")
                    div.chi-badge.-primary.-xs 2
                button.chi-button.-flat.-icon(id="button-support" aria-label="Support" data-tooltip="Support" data-position="bottom")
                  .chi-button__content
                    i.chi-icon.icon-circle-question-outline(aria-hidden="true")
                .chi-divider.-vertical
                .chi-dropdown.-d--none.-d-lg--flex
                  button.chi-button.-flat.chi-dropdown__trigger.-px--1.-animate(id="button-user-menu2", data-position="bottom-end") Menu
                  .chi-dropdown__menu.-w--sm
                    ...
                    a.chi-dropdown__menu-item(href="#")
                      ...
                      span Item 2
                .chi-dropdown.-d--none.-d-lg--flex
                  button.chi-button.-flat.chi-dropdown__trigger.-px--1.-animate(id="button-eid-menu2", data-position="bottom-end") Menu
                  .chi-dropdown__menu.-w--sm
                    a.chi-dropdown__menu-item(href="#")
                      i.chi-icon.icon-user(aria-hidden="true")
                      span Item 1
