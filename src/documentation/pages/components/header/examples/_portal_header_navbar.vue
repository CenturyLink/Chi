        ...
        nav.chi-header__content(aria-label='Header primary navigation')
          ...
          .chi-header__start
            ...
            .chi-dropdown.-d--none.-d-lg--flex
              button.chi-button.-flat.chi-dropdown__trigger.-text--xl.-px--1.-animate(id="button-site-menu3") App Name
          ...
          .chi-header__end
            div.-d--none.-d-lg--flex
              button.chi-button.-flat.-icon(id="button-nav-notification" aria-label="Notifications" data-tooltip="Notifications" data-position="bottom")
                .chi-button__content
                  i.chi-icon.icon-bell-outline(aria-hidden="true")
                  div.chi-badge.-primary.-xs 2
              button.chi-button.-flat.-icon(id="button-nav-support" aria-label="Support" data-tooltip="Support" data-position="bottom")
                .chi-button__content
                  i.chi-icon.icon-circle-question-outline(aria-hidden="true")
              .chi-divider.-vertical
              .chi-dropdown.-d--none.-d-lg--flex
                button.chi-button.-flat.chi-dropdown__trigger.-px--1.-animate(id="button-user-menu3", data-position="bottom-end") Menu
                .chi-dropdown__menu.-w--sm
                  ...
                  a.chi-dropdown__menu-item(href="#")
                    ...
                    span Item 2
              .chi-dropdown.-d--none.-d-lg--flex
                button.chi-button.-flat.chi-dropdown__trigger.-px--1.-animate(id="button-eid-menu3", data-position="bottom-end") Menu
                .chi-dropdown__menu.-w--sm
                  a.chi-dropdown__menu-item(href="#")
                    i.chi-icon.icon-user(aria-hidden="true")
                    span Item 1
                  a.chi-dropdown__menu-item(href="#")
                    i.chi-icon.icon-logout(aria-hidden="true")
                    span Item 2
        nav.chi-header__navbar(aria-label='Header secondary navigation')
          .chi-header__start
            .-d--none.-d-lg--flex
...
export default class PortalHeaderNavbar extends Vue {
  mounted() {
    chi.dropdown(document.getElementById('button-site-menu3'));
    chi.dropdown(document.getElementById('button-user-menu3'));
    chi.dropdown(document.getElementById('button-eid-menu3'));
    chi.tooltip(document.getElementById('button-nav-notification'));
    chi.tooltip(document.getElementById('button-nav-support'));
  }
}
