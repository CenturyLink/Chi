<template lang="pug">
  <ComponentExample title="Header with Title, Buttons, and Collapsible Search" id="header_collapse_search_centurylink" padding="-p--0" :tabs="exampleTabs">
    div(slot="example")
      .-p--3(style='background-color:#eee;')
        header.chi-header
          nav.chi-header__content
            ...
            .chi-header__start
              .-d--flex.-d-lg--none
                button#drawer-trigger-ctl-htb2.chi-button.-icon.-flat.chi-drawer__trigger(data-target='#drawer-ctl-1', aria-label="Toggle navigation")
                  .chi-button__content
                    i.chi-icon.-sm--2.icon-menu(aria-hidden="true")
            .chi-header__end
              .-d--none.-d-lg--flex
                form
                  .chi-search.-collapsed.-mx--1
                    .chi-input__wrapper.-icon--right
                      input#example-search-id2.chi-input.chi-search__input(type='text' placeholder='Search' aria-label='Search')
