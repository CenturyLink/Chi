<template lang="pug">
  <ComponentExample title="Header with top toolbar" id="header_toolbar_centurylink" padding="-p--0" additionalClasses="-bg--grey-20" :tabs="exampleTabs">
    .-p--3(slot="example")
      header.chi-header
        nav.chi-header__toolbar
          .chi-header__start
            ul.chi-tabs
              li
                a(href="#") Item
              ...
              li.chi-dropdown.-active
                a.chi-dropdown__trigger.-animate(href='#') Item
                .chi-dropdown__menu
                  a.chi-dropdown__menu-item(href='#') Elem 1
                  a.chi-dropdown__menu-item(href='#') Elem 2
                  a.chi-dropdown__menu-item(href='#') Elem 3
          .chi-header__end
            a(href="#") Item
            a.-ml--2(href="#") Item
        .chi-divider.-m--0.-w--100
        nav.chi-header__content
          ...
          .chi-header__end
            .-d--flex.-d-lg--none
              button#drawer-trigger-ctl-htt1.chi-button.-icon.-flat.chi-drawer__trigger(data-target='#drawer-ctl-0', aria-label="Toggle navigation")
                .chi-button__content
    ...
    <div class="chi-header__start">
      <ul class="chi-tabs">
        ...
        <li class="chi-dropdown -active">
          <a class="chi-dropdown__trigger -animate" href="#" id="dropdown-trigger-ctl-htt1">Item</a>
  ...
  <nav class="chi-header__content">
    ...
    <div class="chi-header__end">
      <div class="-d--flex -d-lg--none">
        <button class="chi-button -icon -flat chi-drawer__trigger" id="drawer-trigger-ctl-htt1" data-target="#drawer-ctl-0" aria-label="Toggle navigation">
...
<!-- Javascript -->
<script>
  chi.drawer(document.getElementById('drawer-trigger-ctl-htt1'));
  chi.dropdown(document.getElementById('dropdown-trigger-ctl-htt1'));
<\/script>`
      }
    };
  }
})
export default class HeaderTopToolbarCenturylink extends Vue {}
</script>
