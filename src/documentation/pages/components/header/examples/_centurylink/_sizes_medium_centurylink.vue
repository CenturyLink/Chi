<template lang="pug">
  <ComponentExample title="Medium (Base)" titleSize="h4" id="size_medium_centurylink" padding="-p--0" additionalClasses="-bg--grey-20" :tabs="exampleTabs">
    .-p--3(slot="example")
      header.chi-header
...
export default class SizesMediumCenturylink extends Vue {}
</script>
