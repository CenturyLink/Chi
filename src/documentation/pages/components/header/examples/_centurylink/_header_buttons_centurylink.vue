<template lang="pug">
  <ComponentExample title="Header with Title and Buttons" id="header_title_buttons_centurylink" padding="-p--0" :tabs="exampleTabs">
      ...
      .-p--3(style='background-color:#eee;')
        header.chi-header
          nav.chi-header__content
            ...
            .chi-header__start
              .-d--flex.-d-lg--none
                button#drawer-trigger-ctl-htb1.chi-button.-icon.-flat.chi-drawer__trigger(data-target='#drawer-ctl-1', aria-label="Toggle navigation")
                  .chi-button__content
...
export default class HeaderTitleButtonCenturylink extends Vue {
  mounted() {}
}
</script>
