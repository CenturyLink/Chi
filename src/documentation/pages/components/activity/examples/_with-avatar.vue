      ...
      .chi-activity
        .chi-activity__day
          .chi-activity__header
            | Monday, Apr 22 2019
          .chi-activity__content(v-for="item in items[0]")
            .chi-activity__item
              .chi-activity__start
                div
                  | {{item}}
              .chi-activity__item-avatar
                .chi-avatar
        ...
        .chi-activity__day
          .chi-activity__header
            | Monday, Apr 21 2019
          .chi-activity__content(v-for="item in items[1]")
            .chi-activity__item
              .chi-activity__start
                div
                  | {{item}}
...
export default class WithAvatar extends Vue {}
</script>
