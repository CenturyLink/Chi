<template lang="pug">
  <ComponentExample title="Excluded dates and week days" id="excluded-dates-week-days" :tabs="exampleTabs">
    ...
    div(style="max-width: 14rem;" slot="example")
      chi-label(for='date-excluded-days-dates') Date
      chi-date-picker(id="date-excluded-days-dates", excluded-dates="02/24/2020, 05/25/2020, 07/03/2020, 09/12/2020, 12/12/2020", excluded-weekdays="0, 6")
...
@Component({
  data: () => {
    return {
      ...
      codeSnippets: {
        webcomponent: `<chi-label for="date-excluded-days-dates">Date</chi-label>
...
export default class ExcludedDatesWeekDays extends Vue {}
</script>
