<template lang="pug">
  div
    <TitleBar title="Dropdown" description="Dropdowns contain and give access to a list of buttons or other elements hidden by default. They are commonly used for menus in web applications." :tabs="pageTabs" />
