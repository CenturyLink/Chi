<template lang="pug">
  <ComponentExample title="Base" id="base_compact_lumen_centurylink" :tabs="exampleTabs" padding="-p--0" titleSize="h4">
    .chi-grid.-no-gutter(slot="example")
      .chi-col.-w--12.-w-md--6
        .-p--3
          chi-pagination(pages="3" current-page="2" compact)
      .chi-col.-w--12.-w-md--6
        .-p--3.-bg--black
          chi-pagination(pages="3" current-page="2" compact inverse)
...
export default class CompactBaseLumenCenturylink extends Vue {}
</script>