<template lang="pug">
  <ComponentExample title="First and Last page buttons" id="first_last_page_buttons" :tabs="exampleTabs" padding="-p--0" titleSize="h4">
...
export default class FirstLastPageButtons extends Vue {}
</script>