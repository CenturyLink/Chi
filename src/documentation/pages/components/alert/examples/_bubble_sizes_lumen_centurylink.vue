<template lang="pug">
  <ComponentExample title="Sizes" titleSize="h4" id="bubble_sizes_lumen_centurylink" padding="-p--1" :tabs="exampleTabs">
    div(slot='example')
      p.-text--bold.-ml--2 sm
      ...
      chi-alert.-m--2(color='success', icon='circle-check', size='lg', title="Success")
        | This is a large success alert
