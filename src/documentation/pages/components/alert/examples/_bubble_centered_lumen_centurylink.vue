<template lang="pug">
  <ComponentExample title="Centered" titleSize="h4" id="bubble_centered_lumen_centurylink" :tabs="exampleTabs">
...
@Component({
  data: () => {
    return {
      ...
      codeSnippets: {
        webcomponent: `<chi-alert color="danger" icon="circle-warning" center>
  This is a centered danger alert
</chi-alert>`,
        htmlblueprint: `<div class="chi-alert -danger -center" role="alert">
