<template lang="pug">
  ...
  p.-text
    | For hands-on examples, consult the Accessibility <a href="https://a11y-style-guide.com/style-guide/section-forms.html#kssref-forms-text-fields" target="_blank">(A11y) Style Guide.</a>

  h3 Resources
  ul.-text
    li
      a(href="https://www.w3.org/WAI/ARIA/apgW3C" target="_blank") ARIA Practices:  
