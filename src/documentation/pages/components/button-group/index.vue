<template lang="pug">
<TitleBar title="Button group" description="Button groups are used to wrap a series of buttons on a single line." :tabs="pageTabs" />
...
// Vue.config.ignoredElements = ['chi-icon', 'chi-button'];
