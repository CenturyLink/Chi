<template lang="pug">
  <ComponentExample title="Base" id="base-lumen-centurylink" :tabs="exampleTabs">
    .chi-toolbar(slot="example")
      .chi-toolbar__header
        .chi-toolbar__start
          .chi-toolbar__search
            .chi-form__item
              chi-search-input(id="example__base")
            ...
            .chi-toolbar__filters-desktop
              ...
              .chi-form__item
                select(class="chi-select", id="example-ba2")
                  ...
                  option Option 2
                  option Option 3
              button.chi-button.-icon.-flat(id="button-b-filters" aria-label="Filters" data-tooltip="Filters" data-position="top")
                .chi-button__content
        ...
        .chi-toolbar__end
          .chi-toolbar__actions
            .chi-toolbar__actions-desktop
              button.chi-button.-icon.-flat(id="button-b-download" aria-label="Download" data-tooltip="Download" data-position="top")
                .chi-button__content
                  i.chi-icon.icon-arrow-to-bottom(aria-hidden="true")
              button.chi-button.-icon.-flat(id="button-b-refresh" aria-label="Refresh" data-tooltip="Refresh" data-position="top")
                .chi-button__content
                  i.chi-icon.icon-refresh(aria-hidden="true")
              button.chi-button.-icon.-flat(id="button-b-column-customization" aria-label="Column Customization" data-tooltip="Column Customization" data-position="top")
                .chi-button__content
