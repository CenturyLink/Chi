...
.example.-mb--3
  .-p--3
    button.chi-button.-mb--2(ref="button" :data-popover-content="example_popover_content")
      | Popover
    Copy(lang="javascript" :code="example")
...
export default class Properties extends Vue {
  example_popover_content = '<div class="chi-popover__content">Bar</div>';
