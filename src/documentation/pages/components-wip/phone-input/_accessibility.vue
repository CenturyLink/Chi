      ...
      .chi-card__content 
        .chi-card__caption
          ul.-text
            ...
            li Test compatibility with various screen readers (like JAWS, NVDA, or VoiceOver) to ensure the phone input component is announced correctly. Options should be clearly read out when navigated.
      ...
      .chi-card__content 
        .chi-card__caption 
          ul.-text
            ...
            li User-Friendly Help Text: Place help text or examples directly below or inside the phone input field to guide users on the correct format.
            li Visible Error Feedback: Design error messages to appear clearly near the phone input field when validation fails, using color, icons, or text to make them noticeable.
            li Sufficient Tap Targets: Ensure phone input fields have large enough tap targets to accommodate users with different levels of dexterity, following touch-friendly design principles.
            li Use spacing, typography, and visual cues effectively.
            li Maintain consistency in the design of the phone input to provide a cohesive user experience.
...
ul.-text
  li
    a(href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/tel" target="_blank") Mozilla Resources for Developers: 
    | Information about the HTML <code>input-type="tel"</code>
  li 
