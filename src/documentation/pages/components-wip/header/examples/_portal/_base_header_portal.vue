    ...
    .-p--3(slot="example")
      header.chi-header.-lg
        nav.chi-header__content
          ...
          .chi-header__start
            .-d--flex.-d-lg--none
              button#drawer-trigger-portal-pib.chi-button.-icon.-flat.chi-drawer__trigger(data-target='#drawer-portal-1', aria-label="Toggle navigation", ref="drawer-trigger-portal-pib")
                .chi-button__content
