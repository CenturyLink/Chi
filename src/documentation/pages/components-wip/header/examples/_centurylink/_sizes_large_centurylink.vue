<template lang="pug">
  <ComponentExample title="Large" titleSize="h4" id="size_large_centurylink" padding="-p--0" additionalClasses="-bg--grey-20" :tabs="exampleTabs">
    .-p--3(slot="example")
...
export default class SizesLargeCenturylink extends Vue {}
</script>
