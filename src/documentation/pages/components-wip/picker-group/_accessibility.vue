      ...
      .chi-card__content 
        .chi-card__caption
          ul.-text
            ...
            li Test compatibility with various screen readers (like JAWS, NVDA, or VoiceOver) to ensure the picker group component is announced correctly. Options should be clearly read out when navigated.
  ...
  .chi-col.-w-sm--12.-w-md--6.-w-lg--6.-mb--3
    .chi-card.-widget
      ...
      .chi-card__content 
        .chi-card__caption 
          ul.-text
            li Ensure all interactive elements in the picker group, meet the minimum target size of 44x44 pixels.
            li Design elements with adequate spacing to prevent accidental activations.
            li Design the picker group with high contrast between text and background colors, ensuring a minimum contrast ratio of 4.5:1 for text.
            li Implement noticeable focus indicators on interactive elements.
            li Use spacing, typography, and visual cues effectively.
            li Maintain consistency in the design of the picker group to provide a cohesive user experience.

p.-text 
  | Find live examples in the <a href="https://www.w3.org/WAI/tutorials/forms/grouping/" target="_blank">W3 picker group Example</a>.  

h3 Resources
ul.-text
  li
    a(href="https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/group_role" target="_blank") Mozilla Resources for Developers: 
    | Information about the ARIA: group role.
  li  
    a(href="https://www.magentaa11y.com/checklist-web/date-picker/" target="_blank") MagentaA11y: 
    | How to test a picker group dialog.
