<template lang="pug">
  <ComponentExample title="Flat" titleSize="h4" :id="exampleId" additionalClasses="-bg--grey-20" :tabs="exampleTabs" :headTabs="headTabs" @chiHeadTabsChange="e => changeSelectedTab(e)">
    div(slot="example")
