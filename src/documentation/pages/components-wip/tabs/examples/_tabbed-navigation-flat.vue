<template lang="pug">
  <ComponentExample title="Flat" id="tabbed-navigation-flat" :tabs="exampleTabs" additionalClasses="-pb--4">
    chi-tabs(slot="example" active-tab='tab-a' id='example__tabbed_navigation_flat' sliding-border)
...
<script>
    ...
    tabbedNavigationFlatElement.tabs = tabbedNavigationFlatElement.tabs = [
        {
          label: 'Active Tab',
          id: 'tab-a',
          children: [
...
<\/script>`
  ...
  mounted() {
    const tabbedNavigationFlatElement = document.querySelector('#example__tabbed_navigation_flat') as TabsListInterface

    if (tabbedNavigationFlatElement) {
      tabbedNavigationFlatElement.tabs = this.tabbedNavigationFlatElement
    }
  }
}
</script>
