<template lang="pug">
  <ComponentExample title="Base with back link and subtitle" id="base_with_back_link_subtitle" :tabs="exampleTabs">
        ...
        .chi-footer__internal
          .chi-footer__internal-content
            .chi-dropdown.chi-footer__language
              a#back-link-subtitle-language-dropdown-button.chi-button.-icon.-flat.-light.-sm.chi-dropdown__trigger(data-position='top-start' aria-label='Select your preferred language')
                .chi-button__content
...
export default class BackLinkSubtitle extends Vue {
  mounted() {
    chi.dropdown(document.getElementById('back-link-subtitle-language-dropdown-button'));
  }
}
</script>
