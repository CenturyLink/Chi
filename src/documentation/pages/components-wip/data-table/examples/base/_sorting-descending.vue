<template lang="pug">
  <ComponentExample title="Default Sorting -- Descending" id="sorting-descending-data-table" :tabs="exampleTabs">
...
export default class DataTableSortingDescending extends Vue { }
</script>
