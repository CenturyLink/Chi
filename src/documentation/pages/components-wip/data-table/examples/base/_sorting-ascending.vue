<template lang="pug">
  <ComponentExample title="Default Sorting -- Ascending" id="sorting-ascending-data-table" :tabs="exampleTabs">
...
export default class DataTableSortingAscending extends Vue { }
</script>
