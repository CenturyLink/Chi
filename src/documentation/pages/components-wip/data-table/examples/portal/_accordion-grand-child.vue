<template lang="pug">
  <ComponentExample title="Accordion Grand Child" id="accordion-grand-child-data-table" :tabs="exampleTabs">
    div(slot="example")
...
export default class DataTableAccordionGrandChild extends Vue { }
</script>
