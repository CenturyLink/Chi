<template lang="pug">
  <ComponentExample titleSize="h4" title="Size -xl" id="size-xl" :tabs="exampleTabs">
    p.-text(slot="example-description")
      | Render a <strong>-xl</strong> size by applying the modifier class <code>-xl</code>.
    <Wrapper slot="example">
      <TableComponent :data="rows" :columns="columns" :getContent="getContent" additionalClasses="-xl" />
    </Wrapper>
...
export default class SizeXl extends Vue {
