<template lang="pug">
  <ComponentExample titleSize="h4" title="Size -sm" id="size-sm" :tabs="exampleTabs">
    p.-text(slot="example-description")
      | Render a <strong>-sm</strong> size by applying the modifier class <code>-sm</code>.
    <Wrapper slot="example">
      <TableComponent :data="rows" :columns="columns" :getContent="getContent" additionalClasses="-sm" />
    </Wrapper>
...
export default class SizeSm extends Vue {
