<template lang="pug">
  <ComponentExample titleSize="h4" title="Switch with Left Label" id="switch-left-label-lumen-centurylink" :tabs="exampleTabs">
...
export default class SwitchLeftLumenCenturyLink extends Vue {}
</script>
