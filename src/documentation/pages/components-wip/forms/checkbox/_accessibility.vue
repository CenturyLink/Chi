<template lang="pug">
  ...
  p.-text
    | For comprehensive details on keyboard support for input fields, refer to our <a :href="`${CHI_URL}/foundations/accessibility/using-keyboard/`" target="_blank">Keyboard Control Guide.</a>
  p.-text
