<template lang="pug">
  <ComponentExample title="Base with back link" id="base-back-link" padding="-p--0" :tabs="exampleTabs">
    chi-main(backlink="Back link", title="App title" slot="example")
          ...
          .chi-footer__internal
            .chi-footer__internal-content.-mw--1200
              .chi-dropdown.chi-footer__language
                a.chi-button.-icon.-flat.-light.-sm.chi-dropdown__trigger(id="language-dropdown-button4" data-position="top-start" aria-label="Select your preferred language")
                  .chi-button__content
...
@Component({
  data: () => {
    return {
      ...
      codeSnippets: {
        webcomponent: `<chi-main backlink="Back link" title="App title">
  <!-- App content goes here -->
