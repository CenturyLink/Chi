<template lang="pug">
  <ComponentExample title="Base with back link, subtitle and buttons" id="base-back-link-subtitle-buttons" padding="-p--0" :tabs="exampleTabs">
          ...
          .chi-footer__internal
            .chi-footer__internal-content.-mw--1200
              .chi-dropdown.chi-footer__language
                a.chi-button.-icon.-flat.-sm.chi-dropdown__trigger(id="language-dropdown-button12" data-position="top-start" aria-label="Select your preferred language")
                  .chi-button__content
