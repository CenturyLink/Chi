<template lang="pug">
  div
    ...
    .chi-grid__container.-pt--3
      ...
      h2 Layout Grid
      p.-text Chi includes a responsive mobile-first 12-column layout grid. Built on the flexbox standards, the Chi layout grid allows for complex layouts with minimal markup and styles.

      h3 Breakpoints
      div(style="overflow-x:auto;").-mb--3
        table.chi-table.-bordered
          thead
            tr
              th Device
      ...
      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.automaticLayout" class="html"></code>
        </pre>

      .chi-grid.-show--example
        .chi-col
        .chi-col
        .chi-col
        .chi-col
      ...
      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.fiveColumns" class="html"></code>
        </pre>
      ...
      .chi-grid.-no-gutter.-show--example
        .chi-col
        .chi-col
        .chi-col
      ...
      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.threeColumns" class="html"></code>
        </pre>
      ...
      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.columnSizing" class="html"></code>
        </pre>
      ...
      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.columnSizeAutomaticLayout" class="html"></code>
        </pre>
      ...
      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.columnWrapping" class="html"></code>
        </pre>
      ...
      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.offsetColumnPositioning" class="html"></code>
        </pre>
      ...
      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.reorderingColumns" class="html"></code>
        </pre>
      ...
      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.viewportColumnSizing" class="html"></code>
        </pre>
      ...
      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.columnStacking" class="html"></code>
        </pre>
      ...
      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.viewportColumnOffset" class="html"></code>
        </pre>
      ...
      .chi-grid.-align--top.-show--example.-mb--3(style="height: 160px")
        .chi-col
        .chi-col
        .chi-col
      ...
      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.alignTop" class="html"></code>
        </pre>

      h4 -align--center

      .chi-grid.-align--center.-show--example.-mb--3(style="height: 160px")
        .chi-col
        .chi-col
        .chi-col
      ...
      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.alignCenter" class="html"></code>
        </pre>
          
      h4 -align--bottom

      .chi-grid.-align--bottom.-show--example.-mb--3(style="height: 128px")
        .chi-col
        .chi-col
        .chi-col
      ...
      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.alignBottom" class="html"></code>
        </pre>         
      ...
      .chi-grid.-show--example.-mb--3(style="height: 160px")
        .chi-col.-align--top
        .chi-col.-align--center
        .chi-col.-align--bottom

      .-mb--4.-mt--2
        <pre class="language-html">
          <code v-highlight="$data.codeSnippets.columnVerticalAlignment" class="html"></code>
        </pre>
...
@Component({
  data(){
    return {
      codeSnippets: {
        fiveColumns: `<!-- five columns of equal width -->
  <div class="chi-grid">
    ...
    <div class="chi-col"></div>
        ...
        threeColumns: `<!-- grid container with collapsed margins -->
  <div class="chi-grid -no-gutter">
    <div class="chi-col"></div>
    <div class="chi-col"></div>
    <div class="chi-col"></div>
  </div>`,
        alignTop: `<div class="chi-grid -align--top" style="height: 160px;">
  <div class="chi-col"></div>
  <div class="chi-col"></div>
  <div class="chi-col"></div>
</div>`,
        alignCenter: `<div class="chi-grid -align--center" style="height: 160px;">
  <div class="chi-col"></div>
  <div class="chi-col"></div>
  <div class="chi-col"></div>
</div>`,
        alignBottom: `<div class="chi-grid -align--bottom" style="height: 160px">
  <div class="chi-col"></div>
  <div class="chi-col"></div>
  <div class="chi-col"></div>
</div>`,
        columnVerticalAlignment: `<div class="chi-grid" style="height: 160px">
  <div class="chi-col -align--top"></div>
  <div class="chi-col -align--center"></div>
  <div class="chi-col -align--bottom"></div>
</div>`,
        viewportColumnOffset: `<div class="chi-grid">
  <div class="chi-col -o-md--6"></div>
</div>`,
        columnStacking: `<div class="chi-grid">
  <div class="chi-col -w-sm--2"></div>
  <div class="chi-col -w-sm--4"></div>
  <div class="chi-col -w-sm"></div>
</div>`,
        viewportColumnSizing: `<!-- 50% on xs viewports; 100% on sm, md, lg and xl viewports -->
<div class="chi-grid">
...
<div class="chi-grid">
  <div class="chi-col -w--6 -w-xl--12"></div>
        ...
        reorderingColumns: `<div class="chi-grid">
  <div class="chi-col -n--3"></div> <!-- displayed last -->
  <div class="chi-col -n--1"></div> <!-- displayed first -->
  <div class="chi-col -n--2"></div> <!-- displayed between -->
</div>`,
        offsetColumnPositioning: `<div class="chi-grid">
  <div class="chi-col -w--5 -o--1"></div>
  <div class="chi-col -w--3 -o--3"></div>
</div>`,
        columnWrapping: `<div class="chi-grid">
  ...
  <div class="chi-col -w--6"></div>
        ...
        columnSizeAutomaticLayout: `<div class="chi-grid">
  <div class="chi-col -w--2"></div>
  <div class="chi-col"></div>
  <div class="chi-col -w--2"></div>
</div>`,
        columnSizing: `<div class="chi-grid">
  <div class="chi-col -w--3"></div>
  <div class="chi-col -w--9"></div>
</div>`,
        automaticLayout: `<!-- three columns of equal width -->
  <div class="chi-grid">
    <div class="chi-col"></div>
    <div class="chi-col"></div>
    <div class="chi-col"></div>
