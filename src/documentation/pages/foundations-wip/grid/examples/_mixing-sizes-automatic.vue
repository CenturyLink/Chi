<template lang="pug">
  div  
    <ComponentExample title="Mixing Column Sizes w/Automatic Layout" titleSize="h3" id="mixing-column-sizes-w-automatic-layout" :tabs="exampleTabs" :showSnippetTabs="false" padding="-p--0" additionalStyle="border: none;" >
      p.-text(slot="example")
