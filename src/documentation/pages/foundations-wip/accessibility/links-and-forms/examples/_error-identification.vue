<template lang="pug">
<TitleAnchor title="Error identification" id="error-identification" titleSize="h2" />
.chi-grid
  .chi-col.-w--12
    .chi-breadcrumb
      ol.-text--normal
  ...
  .chi-col.-w--12
    p.-text
      | <strong>Benefits:</strong> Blind, colorblind, cognitive/intellectual disabilities.
    p.-text
...
export default class ErrorIdentification extends Vue {}
</script>
