<template lang="pug">
<TitleAnchor title="Captions prerecorded" id="captions-prerecorded" titleSize="h2" />
.chi-grid
  .chi-col.-w--12
    .chi-breadcrumb
      ol.-text--normal
    ...
    return {
      breadcrumbs: [
        ...
        },
        {
          ...
          text: '1.2.2 Captions (Prerecorded)',
        },
      ],
      badges: [
        {
...
export default class CaptionsPrerecorded extends Vue {}
</script>
