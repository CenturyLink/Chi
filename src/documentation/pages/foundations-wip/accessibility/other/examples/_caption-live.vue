<template lang="pug">
<TitleAnchor title="Captions live" id="captions-live" titleSize="h2" />
.chi-grid
  .chi-col.-w--12
    .chi-breadcrumb
      ol.-text--normal
  ...
  .chi-col.-w--12
    p.-text
      | <strong>Benefits:</strong> Deaf, hearing loss disabilities.
    p.-text
  ...
  data: () => {
    return {
      ...
      checklist: [
        {
          itemText:
            'Can people who are deaf or hard of hearing to watch real-time presentations, including dialogue, and identifies who is speaking, and notates sound effects and other significant audio?',
          subItems: ['Applies to the broadcast of synchronized media.'],
        },
      ],
    };
  },
})
export default class CaptionsLive extends Vue {}
</script>
