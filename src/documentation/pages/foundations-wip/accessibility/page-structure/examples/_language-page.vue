<template lang="pug">
  div
    <TitleAnchor title="Language of the page" id="language-page" titleSize="h2" />
    .chi-grid
      .chi-col.-w--12
        .chi-breadcrumb
          ol.-text--normal
      ...
      .chi-col.-w--12
        p.-text
          | <strong>Benefits:</strong> All users.
        p.-text
  ...
  data: () => {
    return {
      breadcrumbs: [
        ...
        {
          url: 'https://www.w3.org/TR/2008/REC-WCAG20-20081211/#meaning-doc-lang-id',
          text: '3.1.1 Language of Page'
        }
      ],
      badges: [
        {
