<template lang="pug">
<TitleAnchor title="Page titled" id="page-titled" titleSize="h2" />
.chi-grid
  .chi-col.-w--12
    .chi-breadcrumb
      ol.-text--normal
  ...
  .chi-col.-w--12
    p.-text
      | <strong>Benefits:</strong> Visual, cognitive, mobility disabled users to be able to identify/differentiate content.
    p.-text
...
export default class PageTitled extends Vue {}
</script>
