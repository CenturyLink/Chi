<template lang="pug">
<TitleAnchor title="Multiple ways" id="multiple-ways" titleSize="h2" />
.chi-grid
  .chi-col.-w--12
    .chi-breadcrumb
      ol.-text--normal
  ...
  .chi-col.-w--12
    p.-text
      | <strong>Benefits:</strong> Visual, cognitive limitations disabilities.
    p.-text
...
export default class MultipleWays extends Vue {}
</script>
