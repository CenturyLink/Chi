            ...
            .chi-epanel__body
              .chi-epanel__content
                .chi-epanel__text
                  ...
                  <Copy id="stylesheet">
                    <pre class="language-html" slot="code">
                      <code v-highlight="stylesheet.HTMLAttribute" lang='bash' class="html"></code>
                    </pre>
                  </Copy>
                  h3.-text--h5.-mt--3 Setting the DOM property
                  <Copy id="stylesheet">
                    <pre class="language-html" slot="code">
                      <code v-highlight="stylesheet.DOMProperty" lang='bash' class="html"></code>
                    </pre>
                  </Copy>
      .chi-epanel.-no-step(data-chi-epanel-group="web-component-details")
        .chi-epanel__header
            ...
            .chi-epanel__body
              .chi-epanel__content
                .chi-epanel__text
                  ...
                  <Copy id="stylesheet">
                    <pre class="language-html" slot="code">
                      <code v-highlight="stylesheet.booleanAttributes.example1" lang='bash' class="html"></code>
                    </pre>
                  </Copy>
                  p.-text
                  ...
                  <Copy id="stylesheet">
                    <pre class="language-html" slot="code">
                      <code v-highlight="stylesheet.booleanAttributes.example2" lang='bash' class="html"></code>
                    </pre>
                  </Copy>
                  p.-text
                  ...
                  <Copy id="stylesheet">
                    <pre class="language-html" slot="code">
                      <code v-highlight="stylesheet.booleanAttributes.example3" lang='bash' class="html"></code>
                    </pre>
                  </Copy>
</template>
