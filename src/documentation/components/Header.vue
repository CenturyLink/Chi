...
header.chi-header.docs-header.-z--20
  ...
  nav.chi-header__content
    #header-brand.chi-header__brand
      button.chi-button.-icon.-flat.-mr-md--2.-d--flex.-d-lg--none.chi-drawer__trigger(
        @click="toggleSidenavDrawer",
        ref="drawerSidenavTrigger"
...
ClientOnly
  chi-drawer.-menu.-position--absolute(ref="drawerSidenav", position="left", no-header, backdrop)
    .-py--2
      <Navigation />
</template>
...
export default class Header extends Vue {
  ...
  mounted() {
    ...
    this.drawerSidenav = this.$refs.drawerSidenav;
  ...
  toggleSidenavDrawer() {
    this.$refs.drawerSidenav.toggle();
  }
}
</script>
