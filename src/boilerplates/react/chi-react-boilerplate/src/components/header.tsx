			...
			<div>
					...
					<nav className="chi-header__content">
						...
						<div className="chi-header__start">
							...
							<div className="chi-dropdown -d--none -d-lg--flex">
								<button
									className="chi-button -flat chi-dropdown__trigger -text--xl -px--1 -animate"
									id="button-site-portal-with-navbar"
								>
									App name
									</button>
								<div className="chi-dropdown__menu -list -w--lg">
									<a className="chi-dropdown__menu-item -h--auto -active" href="#">
										<span className="chi-dropdown__menu-item_title">App name</span>
										<span className="chi-dropdown__menu-item_text"
										>App description</span
										>
									</a>
									<a className="chi-dropdown__menu-item -h--auto" href="#">
										<span className="chi-dropdown__menu-item_title">App name 2</span>
										<span className="chi-dropdown__menu-item_text"
										>App description</span
										>
									</a>
									<a className="chi-dropdown__menu-item -h--auto" href="#">
										<span className="chi-dropdown__menu-item_title">App name 3</span>
										<span className="chi-dropdown__menu-item_text"
										>App description</span
										>
									</a>
						...
						<div className="chi-header__end">
							<div className="-d--none -d-lg--flex">
								<button className="chi-button -flat -icon" aria-label="Notifcations">
									<div className="chi-button__content">
										<i className="chi-icon icon-bell-outline" aria-hidden="true"></i>
										<div className="chi-badge -primary -xs">2</div>
									</div>
								</button>
								<button className="chi-button -flat -icon" aria-label="Support">
									<div className="chi-button__content">
										<i
								...
								<div className="chi-divider -vertical"></div>
								<div className="chi-dropdown -d--none -d-lg--flex">
									<button
										className="chi-button -flat chi-dropdown__trigger -px--1 -animate"
				...
				<div className="chi-backdrop -closed">
					<div className="chi-backdrop__wrapper">
						<div className="chi-drawer -left -menu -position--absolute" id="drawer-1">
							...
							<div className="chi-drawer__content">
								<div className="-px--2 -text">Drawer content here</div>
							</div>
						</div>
					</div>
				</div>
