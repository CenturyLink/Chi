          ...
          <ul class="chi-header__navbar-menu">
            ...
            <li>
              <a href="#" target="_blank">
                Contact Us
                <i
                  class="chi-icon icon-chevron-right -xs"
                  aria-hidden="true"
                ></i>
              </a>
            </li>
...
import { Drawer } from '../es6/components/drawer';
import { Dropdown } from '../es6/components/dropdown';

@Component
export default class Header extends Vue {
  mounted() {
    new Drawer(document.getElementById('drawer-portal-with-navbar'));
    new Dropdown(
