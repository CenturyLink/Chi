...
//#region Data Table
export const DATA_TABLE_NO_RESULTS_MESSAGE = 'No matching results';
export const DATA_TABLE_NO_FILTERS_MESSAGE = 'Search for or select at least one filter to get results';
