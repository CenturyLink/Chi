...
import { ACTIVE_CLASS, DROPDOWN_CLASSES, GENERIC_SIZE_CLASSES, ICON_CLASS, TABS_CLASSES, UTILITY_CLASSES, INVERSE_CLASS, } from "../../constants/classes";
...
export class Tabs {
    ...
    availableSpace = 0;
    dropdownKey = 0;
    slidingBorderElement = null;
    lisArrayLength = 0;
    liSizes = {};
    seeMoreTriggerAnchorElement;
    seeMoreTriggerElement;
    seeMoreTriggerElementWidth = 0;
    ulElement;
    uuid4 = uuid4();
    seeMoreTriggerId = `see-more-trigger-${this.uuid4}`;
    slidingBorderLeft;
    dropdownKeys = {};
    seeMoreDropdown;
    liMarginLeft;
    ...
    handlerMouseLeave = (e, isTargetMenu) => {
    ...
    getTabElements() {
        ...
        this.tabs?.forEach((tab, index) => {
            ...
            tabs.push(h("li", { class: `${TABS_CLASSES.TRIGGER} ${this._isActiveTab(tab) ? ACTIVE_CLASS : ''}`, "data-index": index, id: tab.id, onMouseEnter: () => {
                ...
                } }, h("a", { href: `#${tab.id}`, class: tab.children ? '-has-child' : '', role: "tab", "aria-selected": this._isActiveTab(tab), "aria-controls": `#${tab.id}`, onClick: (e) => this.handlerClickTab(e, tab), innerHTML: tab.label })));
        });
        return tabs;
    }
    getSlidingBorder() {
    ...
    render() {
        ...
        return (h(Host, { key: '92fd4c6b65a2aa40333574705cf4f5e77f54f6ab' }, h("ul", { key: '56fca26efdeb946c6f478c8ada6cfcc078965529', class: `
            ${TABS_CLASSES.TABS}
          ...
          `, ref: (el) => {
                this.ulElement = el;
            }, onMouseLeave: (e) => this.handlerMouseLeave(e, true), role: "tablist" }, tabElements, seeMoreTrigger, slidingBorder), dropdowns));
    }
