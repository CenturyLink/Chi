...
export class Popover {
    ...
    render() {
        ...
        const popoverHeader = this.popoverTitle && (h("header", { key: '4c5078954160312896ea7822811b377a502bb061', ref: (el) => (this._popoverHeader = el), class: POPOVER_CLASSES.HEADER }, h("h2", { key: '9daf0533b3a3bea0f012eed187a830c960896e6d', class: POPOVER_CLASSES.TITLE }, this.popoverTitle)));
        const slot = this.variant && this.variant === 'text' ? (h("p", { class: POPOVER_CLASSES.TEXT }, h("slot", null))) : (h("slot", null));
        const chiFooter = this.popoverFooter && (h("div", { key: '711ca061bb03ad666a477ec9bdd0a0f017df9f18', class: POPOVER_CLASSES.FOOTER }, h("slot", { key: '56620e1b2eb8a122d21939661c958bfcb7e61d06', name: POPOVER_CLASSES.FOOTER })));
        return (h("section", { key: '238c0228a0d744d025ca285a334e85c1bccb4ef8', class: `
        ...
        `, ref: (el) => (this._popoverElement = el), onClick: () => this.preventAutoClose(), role: "dialog", "aria-modal": "true", "aria-label": this.popoverTitle, "aria-hidden": !this.active }, closeButton, popoverHeader, h("div", { key: 'f40eceff8b816eb91a47632255abbd1fe1890d14', class: POPOVER_CLASSES.CONTENT }, slot), chiFooter, this.arrow && h("div", { key: '3ad11dafa99c181f98ca726a6e80e3b5ebac9151', class: POPOVER_CLASSES.ARROW })));
    }
