...
export class SearchInput {
    ...
    render() {
        const isAutocomplete = this._isAutocomplete();
        const searchInputElement = (h("input", { key: '0ab5edffad065e565027bf544d66efe1319cebcb', type: "search", class: `
        ...
        const searchIcon = (h("button", { key: 'f1b4c1749b68ac7b7eb4cdbc79177fcf4c733526', class: `
        chi-button -icon -flat -bg--none
        ${this.size ? `-${this.size}` : ''}
        `, onClick: () => this.eventSearch.emit(this.value), "aria-label": "Search" }, h("div", { key: 'fee8019d7adf785391b570b58d150b6bc206f5e5', class: "chi-button__content" }, h("i", { key: 'e3173d678cd74bd93e8eecb7533c5e6c59521731', class: 'chi-icon icon-search', "aria-hidden": "true" }))));
        const input = (h("div", { key: '3906f98575aed5a7a708a86475203ecbce28140b', class: "chi-input__wrapper -icon--right", slot: "trigger" }, searchInputElement, searchXIcon, searchIcon));
