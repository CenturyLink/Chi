...
export class Date {
    ...
    render() {
        ...
        return (h("div", { key: 'e47cee1720de99b9e97e4e78e584cbd8fa4c0de8', class: `${DATEPICKER_CLASSES.DATEPICKER} ${this._vm.weekStartClass} ${this._vm.monthStartClass}` }, h("div", { key: '5471a954892b49dd35a48a250d070e5e1d5929d2', class: `${DATEPICKER_CLASSES.MONTH_ROW}` }, h("div", { key: '20c9ff56eedcbd7a44e7f86833e3ebfc1c83b3f4', class: `${DATEPICKER_CLASSES.PREV_MONTH} ${prevMonthDisabled ? CLASSES.DISABLED : ''}`, tabindex: "0", onClick: () => this.prevMonth() }, h("chi-icon", { key: '76556e45783c084df50417137906567c4643f857', icon: "chevron-left", size: "sm" })), h("div", { key: 'd4e0fcb43e40e1c35e3a5ef1d11e156abaed4534', class: `${DATEPICKER_CLASSES.MONTH}` }, `${this.viewMonth.format('MMMM')}
              ${this.viewMonth.format('YYYY')}`), h("div", { key: 'ec5e6238235675ed3dafc566201408ddbb7fbbd0', class: `${DATEPICKER_CLASSES.NEXT_MONTH} ${nextMonthDisabled ? CLASSES.DISABLED : ''}`, tabindex: !nextMonthDisabled ? '0' : '', onClick: () => this.nextMonth() }, h("chi-icon", { key: 'c3d71c4a05478889c627312a70a81aea51f5dfca', icon: "chevron-right", size: "sm" }))), h("div", { key: 'f6ff41751125275dbf02e00e4516cf5bdc997335', class: `${DATEPICKER_CLASSES.DAY_NAMES}` }, this._vm.weekDays.map((weekDay) => (h("div", { class: `${DATEPICKER_CLASSES.WEEK_DAY}`, key: weekDay.format('dddd') }, weekDay.format('dddd').substr(0, 1))))), h("div", { key: '5b431289c45741e013a5615cbb2af22508c50d3a', class: `${DATEPICKER_CLASSES.DAYS}` }, this._vm.monthDays.map((day) => {
