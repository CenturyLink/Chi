import{V as C,N as y}from"./uJTUijt2.js";import{e as g,c as D}from"./DAzwSQBh.js";import{_ as S}from"./D8GK0F__.js";import{_ as T}from"./DKu8Jd2y.js";import{o as A,f as V,w as o,r as n,b as a,a as t,d as _}from"./B5CYXVwa.js";import{_ as B}from"./DlAUqK2U.js";import"./2EwpEKcw.js";import"./C-hgEc7b.js";import"./drvuhYu1.js";var O=Object.defineProperty,z=Object.getOwnPropertyDescriptor,I=(i,e,r,l)=>{for(var c=l>1?void 0:l?z(e,r):e,h=i.length-1,s;h>=0;h--)(s=i[h])&&(c=(l?s(e,r,c):s(c))||c);return l&&c&&O(e,r,c),c};let u=class extends C{};u=I([y({data:()=>({toolbar:g,saveView:D,exampleTabs:[{disabled:!0,id:"webcomponent",label:"Web Component"},{active:!0,id:"vue",label:"Vue"},{id:"htmlblueprint",label:"HTML Blueprint"}],codeSnippets:{vue:`<!-- Vue component -->
<ChiDataTableToolbar>
...
<\/script>`}})})],u);const P=t("div",{class:"chi-divider -vertical"},null,-1),F=t("div",{class:"chi-divider -vertical"},null,-1),R={class:"chi-form__item"},H=t("chi-label",{for:"input-1"},"City",-1),E=t("chi-label",{for:"input-2"},"Zip Code",-1),L=t("button",{class:"chi-button -icon -flat","aria-label":"Refresh"},[t("div",{class:"chi-button__content"},[t("i",{class:"chi-icon icon-refresh","aria-hidden":"true"})])],-1),N=t("button",{class:"chi-button -icon -flat","aria-label":"Download"},[t("div",{class:"chi-button__content"},[t("i",{class:"chi-icon icon-arrow-to-bottom","aria-hidden":"true"})])],-1),$=t("div",{class:"chi-bulk-actions"},[t("div",{class:"chi-bulk-actions__start"},[t("div",{class:"chi-bulk-actions__results"},[t("div",{class:"chi-bulk-actions__label"},"Actions (10 Selected)"),t("div",{class:"chi-form__item"},[t("div",{class:"chi-checkbox"},[t("input",{class:"chi-checkbox__input",id:"checkbox-ba1",type:"checkbox"}),t("label",{class:"chi-checkbox__label",for:"checkbox-ba1"},"Show Selected Only")])])]),t("div",{class:"chi-divider -vertical"}),t("div",{class:"chi-bulk-actions__buttons"},[t("div",{class:"chi-bulk-actions__buttons-mobile -position--absolute"},[t("chi-button",{variant:"flat",type:"icon","alternative-text":"Button action","data-tooltip":"Edit"},[t("chi-icon",{icon:"edit"})]),t("chi-button",{variant:"flat",type:"icon","alternative-text":"Button action","data-tooltip":"Compose"},[t("chi-icon",{icon:"compose"})]),t("chi-button",{variant:"flat",type:"icon","alternative-text":"Button action","data-tooltip":"Delete"},[t("chi-icon",{icon:"delete"})]),t("chi-button",{variant:"flat",type:"icon","alternative-text":"Button action","data-tooltip":"Print"},[t("chi-icon",{icon:"print"})])]),t("div",{class:"chi-bulk-actions__buttons-desktop"},[t("chi-button",{size:"xs"},[t("chi-icon",{icon:"arrow-to-bottom"}),t("span",null,"Download")]),t("chi-button",{size:"xs"},[t("chi-icon",{icon:"compose"}),t("span",null,"Compose")]),t("chi-button",{size:"xs"},[t("chi-icon",{icon:"delete"}),t("span",null,"Delete")]),t("chi-button",{size:"xs"},[t("chi-icon",{icon:"print"}),t("span",null,"Print")])])])]),t("div",{class:"chi-bulk-actions__end"},[t("chi-button",{type:"close"})])],-1),W=t("div",{class:"chi-tab__description"},[_("Use the slots "),t("code",null,"start"),_(" to add elements to the left side area of the Toolbar Header and the "),t("code",null,"end"),_(" - to the right side.")],-1),j=t("div",{class:"chi-tab__description"},[_("To render toolbar, use the class "),t("code",null,"chi-toolbar"),_(".")],-1);function Z(i,e,r,l,c,h){const s=n("ChiSearchInput"),p=n("ChiDataTableViews"),m=n("ChiDataTableFilters"),v=n("ChiTooltip"),w=n("ChiColumnCustomization"),f=n("ChiDataTableToolbar"),x=n("ChiSaveView"),b=S,k=T;return A(),V(k,{title:"Base with save view and bulk actions",id:"base-with-save-view-and-bulk-actions-portal",additionalStyle:"position: static;",additionalClasses:"-position--relative",tabs:i.exampleTabs},{example:o(()=>[a(f,null,{start:o(()=>[a(s,{dataTableSearch:!0}),P,a(p,{views:i.toolbar.viewsData},null,8,["views"]),F,a(m,{class:"-ml--2",filtersData:i.toolbar.filtersData,customItems:i.toolbar.customItemsData},{customAdvanced:o(()=>[t("div",R,[H,t("chi-text-input",{id:"input-1","on:chiChange":e[0]||(e[0]=d=>i.inputOneChangeHandler(d))},null,32),E,t("chi-text-input",{id:"input-2","on:chiChange":e[1]||(e[1]=d=>i.inputTwoChangeHandler(d))},null,32)])]),customAdvanced2:o(()=>[t("chi-date-picker",{"on:chiDateChange":e[2]||(e[2]=d=>i.dateChangeHandler(d))},null,32)]),_:1},8,["filtersData","customItems"])]),end:o(()=>[a(v,{message:"Refresh"},{default:o(()=>[L]),_:1}),a(v,{message:"Download"},{default:o(()=>[N]),_:1}),a(w,{columnsData:i.toolbar.columnsData},null,8,["columnsData"])]),_:1}),a(x,{config:i.saveView},null,8,["config"]),$]),"code-webcomponent":o(()=>[a(b,{code:i.codeSnippets.webcomponent,lang:"html"},null,8,["code"])]),"code-vue":o(()=>[W,a(b,{code:i.codeSnippets.vue,lang:"html"},null,8,["code"])]),"code-htmlblueprint":o(()=>[j,a(b,{class:"html",code:i.codeSnippets.htmlblueprint},null,8,["code"])]),_:1},8,["tabs"])}const it=B(u,[["render",Z]]);export{it as default};
