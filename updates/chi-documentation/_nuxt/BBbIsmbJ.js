...
</div>`}})})],o);const x=r("div",{class:"chi-tab__description"},[m("Use "),r("code",null,"active"),m(" property to achieve active state of rows")],-1);function C(a,i,d,t,e,c){const l=N("ChiDataTable"),v=h,p=u;return f(),g(p,{title:"Active",id:"active-data-table",tabs:a.exampleTabs},{example:n(()=>[s(l,{config:a.config,dataTableData:a.table},null,8,["config","dataTableData"])]),"code-vue":n(()=>[x,s(v,{lang:"html",code:a.codeSnippets.vue},null,8,["code"])]),"code-htmlblueprint":n(()=>[s(v,{lang:"html",code:a.codeSnippets.htmlblueprint},null,8,["code"])]),_:1},8,["tabs"])}const O=D(o,[["render",C]]);export{O as default};
