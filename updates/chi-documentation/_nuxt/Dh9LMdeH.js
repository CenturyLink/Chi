...
}`}}})],b);const $=r("div",{class:"chi-tab__description"},[m("Use "),r("code",null,"sortBy"),m(" and "),r("code",null,"sortDataType"),m(" properties to make the column sortable")],-1);function V(a,i,s,n,e,d){const l=C("ChiDataTable"),v=h,_=f;return p(!0),D(w,null,N(a.sortingTypes,t=>(p(),L(_,{key:t.id,title:t.title,id:t.id,tabs:a.exampleTabs},{example:o(()=>[c(l,{config:a.getConfig(t.defaultSort),dataTableData:a.table},null,8,["config","dataTableData"])]),"code-vue":o(()=>[$,c(v,{code:a.getVueCode(t.defaultSort),lang:"html"},null,8,["code"])]),"code-htmlblueprint":o(()=>[c(v,{code:a.getHtmlCode(t.defaultSort),lang:"html"},null,8,["code"])]),_:2},1032,["title","id","tabs"]))),128)}const E=y(b,[["render",V]]);export{E as default};
