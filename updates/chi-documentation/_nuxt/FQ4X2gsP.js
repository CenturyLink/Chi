...
</div>`}})})],r);const x={class:"chi-card -portal -bg--white"},C=i("div",{class:"chi-card__header -sm"},[i("div",{class:"chi-card__title"},"Title")],-1),L={class:"chi-card__content -p--0"},w=i("div",{class:"chi-tab__description"},[m("Use "),i("code",null,"portal"),m(" config to achieve portal styling")],-1);function B(a,t,c,d,e,s){const l=N("ChiDataTable"),v=h,_=u;return g(),f(_,{title:"Base",id:"base-portal-data-table",tabs:a.exampleTabs},{example:n(()=>[i("div",x,[C,i("div",L,[o(l,{config:a.config,dataTableData:a.table},null,8,["config","dataTableData"])])])]),"code-vue":n(()=>[w,o(v,{lang:"html",code:a.codeSnippets.vue},null,8,["code"])]),"code-htmlblueprint":n(()=>[o(v,{lang:"html",code:a.codeSnippets.htmlblueprint},null,8,["code"])]),_:1},8,["tabs"])}const j=D(r,[["render",B]]);export{j as default};
