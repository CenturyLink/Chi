...
| modal | chi-modal | -no-border, -centered, -active, -animated, -transitioning, -header-image, -has-top-image, -gradient, ... | chi-modal__header, chi-modal__content, chi-modal__top-image-wrapper, chi-modal__top-image, ... | `<chi-modal>` |
