...
| carousel | chi-carousel | -previous, -next, -float, -dots, -pagination, -fade-hidden-items, -active | chi-carousel__content, chi-carousel__dots, chi-carousel__pagination | `<chi-carousel>` |
