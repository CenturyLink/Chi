...
| drawer | chi-drawer | -active, -animated, -transitioning, -top, -menu, -right, -bottom, -left | chi-drawer__header-main, chi-drawer__header-actions, chi-drawer__compact-title, chi-drawer__title-group, ... | `<chi-drawer>` |
