...
<div class="chi-avatar -xxl">
  <img src="path/to/image.jpg">
</div>`}},s=L("initial"),m=u=>{s.value=u.id};return(u,h)=>{const i=A,k=w;return c(),y(k,{title:"Size",id:"size",tabs:d,"head-tabs":t,onChiHeadTabsChange:m},{"example-description":n(()=>h[0]||(h[0]=[a("p",{class:"-text"},[e("All three avatar styles support a full spectrum of sizes: "),a("code",null,"-xs"),e(", "),a("code",null,"-sm"),e(", "),a("code",null,"-sm--2"),e(", "),a("code",null,"-sm--3"),e(", "),a("code",null,"-md"),e(", "),a("code",null,"-lg"),e(", "),a("code",null,"-xl"),e(", "),a("code",null,"-xxl"),e(". "),a("code",null,"-md"),e(" is the default size.")],-1)])),example:n(()=>[a("div",aa,[a("div",ia,[(c(),p(_,null,T(v,x=>a("div",{class:f(`chi-col -w--${l[x][0]} -w-lg--${l[x][1]} -w-xl--${l[x][2]} -text--center`)},[a("div",{class:f(`chi-avatar -${x}`)},[e($(s.value==="initial"?"AA":""),1),s.value==="icon"?(c(),p("i",ea)):C("",!0),s.value==="image"?(c(),p("img",ta)):C("",!0)],2),a("p",sa,$(x),1)],2)),64))])])]),"code-htmlblueprint":n(()=>[o(i,{lang:"html",code:r.htmlblueprint[s.value]},null,8,["code"])]),_:1})}}}),da=b({__name:"index",setup(g){return(d,t)=>(c(),p(_,null,[t[0]||(t[0]=a("h2",null,"Examples",-1)),t[1]||(t[1]=a("p",{class:"-text"},[e("To render an avatar, apply the class "),a("code",null,"chi-avatar"),e(" to a div element and place an image inside.")],-1)),o(z),o(X),o(Y),t[2]||(t[2]=a("h2",null,"Customizations",-1)),o(q),o(Z),o(na),o(W)],64))}});export{da as _};
