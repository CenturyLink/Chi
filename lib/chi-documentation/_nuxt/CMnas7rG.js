const a=(t,e)=>{switch(t.key){case"class":return`<code>-bg--${e.name}</code>`;case"value":return`<code>background-color: ${e.value}</code>`;case"result":return`<div class="-text -b--1" style="background-color:${e.value}; height:15px;"></div>`;default:return""}},s=(t,e)=>{switch(t.key){case"class":return`<code>-text--${e.name}</code>
