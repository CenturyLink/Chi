import{e as f,g as v,h as C,o as A,f as $,w as l,a as c,b as t,d as x,r as V,c as I,i as S,j as q,F as R,t as W,k as N,l as F}from"./CR_XfkrP.js";import{_ as E}from"./CBk3mWUi.js";import{_ as y}from"./Apvmmo3P.js";import{_ as B}from"./BUnP1NT4.js";function r(n,o=!1,d=3){const e="  ".repeat(d),_=`<div class="chi-accordion__title">${n}</div>`,m='<i class="chi-icon icon-chevron-down" aria-hidden="true"></i>';return o?`${_}
${e}${m}`:`${m}
${e}${_}`}const U=["portal"],L=f({__name:"_base",props:{portal:{type:Boolean}},setup(n){const o=n,d=v("example-base");C(()=>{d.value&&(d.value.accordions=[{title:"Accordion 1",text:"Content goes here"},{title:"Accordion 2",text:"Content goes here",expanded:!0},{title:"Accordion 3",text:"Content goes here"},{title:"Accordion 4",text:"Content goes here"}])});const e={webcomponent:`<chi-accordion id="example-base"${o.portal?" portal":""}></chi-accordion>
...
<\/script>`};return(_,m)=>{const p=E,s=y,h=B;return A(),$(h,{title:"Base",padding:"-p--3 -p-lg--6",id:"base"},{example:l(()=>[c("chi-accordion",{ref:"example-base",portal:n.portal},null,8,U)]),"code-webcomponent":l(()=>[t(p,{class:"html",lang:"html",code:e.webcomponent},null,8,["code"])]),"code-htmlblueprint":l(()=>[t(s),t(p,{lang:"html",code:e.htmlblueprint},null,8,["code"])]),_:1})}}}),M=["portal"],G=f({__name:"_card",props:{portal:{type:Boolean}},setup(n){const o=n,d=v("example-card");C(()=>{d.value&&(d.value.accordions=[{title:"Accordion 1",text:"Content goes here"},{title:"Accordion 2",text:"Content goes here",expanded:!0},{title:"Accordion 3",text:"Content goes here"},{title:"Accordion 4",text:"Content goes here"}])});const e={webcomponent:`<chi-accordion id="example-card" card${o.portal?" portal":""}></chi-accordion>
...
<\/script>`};return(_,m)=>{const p=E,s=y,h=B;return A(),$(h,{title:"Card",id:"card",padding:"-p--3 -p-lg--6"},{example:l(()=>[c("chi-accordion",{ref:"example-card",portal:n.portal,card:""},null,8,M)]),"code-webcomponent":l(()=>[t(p,{class:"html",lang:"html",code:e.webcomponent},null,8,["code"])]),"code-htmlblueprint":l(()=>[t(s),t(p,{lang:"html",code:e.htmlblueprint},null,8,["code"])]),_:1})}}}),K=["portal"],P={slot:"main-accordion-content"},Q=["portal"],X={slot:"parent-accordion-1-content"},Y=["portal"],Z={slot:"child-accordion-content"},oo=["portal"],co={slot:"parent-accordion-2-content"},to=["portal"],O=f({__name:"_nested",props:{portal:{type:Boolean}},setup(n){const o=n,d=v("main-accordion"),e=v("parent-accordion"),_=v("child-accordion-1"),m=v("child-accordion-2"),p=v("grandchild-accordion"),s=(i,a)=>{i!=null&&i.value&&(i.value.accordions=a)};C(()=>{s(d,[{title:"Click me to expand Accordion",template:"main-accordion-content"}]),s(e,[{title:"Accordion 1",template:"parent-accordion-1-content"},{title:"Accordion 2",template:"parent-accordion-2-content"}]),s(_,[{title:"Accordion 1.1",template:"child-accordion-content"},{title:"Accordion 1.2",text:"Content of Accordion item 1.2"}]),s(p,[{title:"Accordion 1.1.1",text:"Content of Accordion item 1.1.1"}]),s(m,[{title:"Accordion 2.1",text:"Content of Accordion item 2.1"}])});const h=o.portal?" portal":"",b={webcomponent:`<chi-accordion id="main-accordion"${h}>
...
<//script>`};return(i,a)=>{const g=E,u=y,w=B;return A(),$(w,{title:"Nested",id:"nested",padding:"-p--3 -p-lg--6"},{example:l(()=>[c("chi-accordion",{ref:"main-accordion",portal:n.portal},[c("div",P,[c("chi-accordion",{ref:"parent-accordion",portal:n.portal},[c("div",X,[a[1]||(a[1]=c("p",{class:"chi-accordion__text"},"Content of Accordion item 1",-1)),c("chi-accordion",{ref:"child-accordion-1",portal:n.portal},[c("div",Z,[a[0]||(a[0]=c("p",{class:"chi-accordion__text -mb--2"},"Content of Accordion item 1.1",-1)),c("chi-accordion",{ref:"grandchild-accordion",portal:n.portal},null,8,oo)])],8,Y)]),c("div",co,[a[2]||(a[2]=c("p",{class:"chi-accordion__text"},"Content of Accordion item 2",-1)),c("chi-accordion",{ref:"child-accordion-2",portal:n.portal},null,8,to)])],8,Q)])],8,K)]),"code-webcomponent":l(()=>[t(g,{lang:"html",code:b.webcomponent},null,8,["code"])]),"code-htmlblueprint":l(()=>[t(u),t(g,{lang:"html",code:b.htmlblueprint},null,8,["code"])]),_:1})}}}),no=["portal"],io={slot:"parent-accordion-content"},eo=["portal"],D=f({__name:"_methods",props:{portal:{type:Boolean}},setup(n){const o=n,d=v("parent-accordion"),e=v("child-accordion");C(()=>{d.value&&(d.value.accordions=[{title:"Accordion",template:"parent-accordion-content",expanded:!0}]),e.value&&(e.value.accordions=[{title:"Accordion 1",text:"Content of Accordion item 1"},{title:"Accordion 2",text:"Content of Accordion item 2"}])});const _=p=>e.value.toggle(p),m={webcomponent:`<chi-button id="toggle-accordion-1"> Toggle item 1 </chi-button>
...
<\/script>`};return(p,s)=>{const h=E,b=y,i=B;return A(),$(i,{title:"Show / Hide / Toggle of individual items of Accordion",id:"methods",padding:"-p--3 p-lg--6"},{example:l(()=>[c("chi-button",{onClick:s[0]||(s[0]=a=>_(0))},"Toggle item 1"),c("chi-button",{class:"-ml--1",onClick:s[1]||(s[1]=a=>_(1))},"Toggle item 2"),c("chi-accordion",{class:"-d--block -mt--2",ref:"parent-accordion",portal:n.portal},[c("div",io,[c("chi-accordion",{ref:"child-accordion",portal:n.portal},null,8,eo)])],8,no)]),"code-webcomponent":l(()=>[t(h,{class:"html",lang:"html",code:m.webcomponent},null,8,["code"])]),"code-htmlblueprint":l(()=>[t(b),t(h,{lang:"html",code:m.htmlblueprint},null,8,["code"])]),_:1})}}}),ao=["portal"],ro={slot:"main-accordion-content"},lo=["portal"],so={slot:"parent-accordion-1-content"},po=["portal"],mo={slot:"parent-accordion-2-content"},ho=["portal"],J=f({__name:"_expand_collapse_all",props:{portal:{type:Boolean}},setup(n){const o=n,d=v("main-accordion"),e=v("parent-accordion"),_=v("child-accordion-1"),m=v("child-accordion-2"),p=[d,e,_,m],s=()=>p.forEach(g=>{var u;return(u=g.value)==null?void 0:u.show()}),h=()=>p.forEach(g=>{var u;return(u=g.value)==null?void 0:u.hide()}),b=(g,u)=>{g!=null&&g.value&&(g.value.accordions=u)};C(()=>{b(d,[{title:"Accordion",template:"main-accordion-content",expanded:!0}]),b(e,[{title:"Accordion item 1",template:"parent-accordion-1-content"},{title:"Accordion item 2",template:"parent-accordion-2-content"}]),b(_,[{title:"Accordion item 1.1",text:"Content of Accordion item 1.1"},{title:"Accordion item 1.2",text:"Content of Accordion item 1.2"}]),b(m,[{title:"Accordion item 2.1",text:"Content of Accordion item 2.1"},{title:"Accordion item 2.2",text:"Content of Accordion item 2.2"}])});const i=o.portal?" portal":"",a={webcomponent:`<chi-button id="expand-all-button">Expand all</chi-button>
...
<\/script>`};return(_,m)=>{const p=E,s=y,h=B;return A(),$(h,{title:"Truncated",id:"truncated",padding:"-p--3 -p-lg--6"},{"example-description":l(()=>m[0]||(m[0]=[c("p",{class:"-text"},[x("Truncate long accordion titles by adding property "),c("code",null,"truncated"),x(" to "),c("code",null,"chi-accordion"),x(".")],-1)])),example:l(()=>[c("chi-accordion",{ref:"example-truncated",portal:n.portal,truncated:""},null,8,uo)]),"code-webcomponent":l(()=>[t(p,{class:"html",lang:"html",code:e.webcomponent},null,8,["code"])]),"code-htmlblueprint":l(()=>[t(s),t(p,{lang:"html",code:e.htmlblueprint},null,8,["code"])]),_:1})}}}),go={class:"-text"},vo={key:0},Ao={class:"-text--bold -pl--2"},xo=["size","portal"],H=f({__name:"_sizes",props:{portal:{type:Boolean}},setup(n){const o=n,d=o.portal?["sm","md"]:["sm","md","lg","xl"],e=V([]);C(()=>{e.value.forEach(i=>{i&&(i.accordions=[{title:"Accordion",text:"Content goes here"}])})});function _(i){return`<!-- ${i} -->
...
<script>
  ${d.map(h).join(`
  `)}
<\/script>`};return(i,a)=>{const g=E,u=y,w=B;return A(),$(w,{title:"Sizes",id:"sizes",padding:"-p--3 -p-lg--6"},{"example-description":l(()=>[c("p",go,[a[1]||(a[1]=x("Accordion supports the following sizes: ")),a[2]||(a[2]=c("code",null,"sm",-1)),a[3]||(a[3]=x(", ")),a[4]||(a[4]=c("code",null,"md",-1)),a[5]||(a[5]=x(" (default)")),n.portal?S("",!0):(A(),I("span",vo,a[0]||(a[0]=[x(", "),c("code",null,"lg",-1),x(", and "),c("code",null,"xl",-1)]))),a[6]||(a[6]=x("."))])]),example:l(()=>[(A(!0),I(R,null,q(N(d),T=>(A(),I(R,{key:T},[c("p",Ao,W(T),1),c("chi-accordion",{size:T,portal:n.portal,ref_for:!0,ref:k=>e.value.push(k)},null,8,xo)],64))),128))]),"code-webcomponent":l(()=>[t(g,{class:"html",lang:"html",code:b.webcomponent},null,8,["code"])]),"code-htmlblueprint":l(()=>[t(u),t(g,{lang:"html",code:b.htmlblueprint},null,8,["code"])]),_:1})}}}),bo={key:0},fo={key:1},Bo=f({__name:"index",setup(n){const o=F();return(d,e)=>(A(),I("div",null,[e[0]||(e[0]=c("h2",null,"Examples",-1)),e[1]||(e[1]=c("p",{class:"-text"},[x("To render accordion, use the class "),c("code",null,"chi-accordion"),x(".")],-1)),["lumen","centurylink"].includes(N(o))?(A(),I("div",bo,[t(L),t(O),t(D),t(J),t(j),t(z),t(H)])):S("",!0),N(o)==="portal"?(A(),I("div",fo,[t(L,{portal:""}),t(G,{portal:""}),t(O,{portal:""}),t(D,{portal:""}),t(J,{portal:""}),t(j,{portal:""}),t(z,{portal:""}),t(H,{portal:""})])):S("",!0)]))}});export{Bo as _};
