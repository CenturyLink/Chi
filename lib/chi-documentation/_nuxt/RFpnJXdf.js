...
}`,O={class:"chi-col -w--10 -w-sm--9",slot:"panels",ref:"panels"},G={class:"chi-tabs-panel",id:"snippet-data-table",role:"tabpanel"},x={class:"chi-tabs-panel",id:"snippet-popover",role:"tabpanel"},k={__name:"vue-snippets",setup(e){const s=u(),t=p("snippetTabs"),c=[{label:"ExampleDataTable.vue",id:"snippet-data-table"},{label:"ExamplePopover.vue",id:"snippet-popover"}],n=g(()=>({dataTableExample:["portal","brightspeed","colt"].includes(s)?f:N,popoverExample:v}));return h(()=>{t.value&&setTimeout(()=>{t.value.activeTab="snippet-data-table"},1e3)}),(T,l)=>{const o=m;return y(),b(D,null,[l[0]||(l[0]=a("div",{class:"chi-tab__description -p--2"},"Create reusable Vue components based on your needs and use them as custom templates for Data Table cells and row accordions",-1)),a("chi-tabs",{class:"-bg--grey-15 -bt--1",tabs:c,vertical:"","extra-class":"-br--1 -pt--3 -h--100",ref:"snippetTabs"},[a("div",O,[a("div",G,[d(o,{lang:"html",code:n.value.dataTableExample},null,8,["code"])]),a("div",x,[d(o,{lang:"html",code:n.value.popoverExample},null,8,["code"])])],512)],512)],64)}}},z=Object.freeze(Object.defineProperty({__proto__:null,default:k},Symbol.toStringTag,{value:"Module"}));export{k as _,S as a,$ as b,P as c,B as h,z as v};
