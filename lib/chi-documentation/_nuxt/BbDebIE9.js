import{ak as t}from"./BnvmtQYM.js";const b=e=>({labelLegend:e.labelGroup??"",required:!!e.required,optional:!!e.optional}),c=({checkedOption:e,...a},r,o)=>{const i=o+1,l=e!==void 0&&i===+e?"checked":"",d=a[`disabledOption${i}`]?"disabled":"",n=a[`labelOption${i}`]||"";return{id:`id="${r}"`,checked:l,disabled:d,label:n}},s=(e,a)=>e?`
