import{_}from"./BskPbflv.js";import{_ as m}from"./CBk3mWUi.js";import{_ as u}from"./BUnP1NT4.js";import{e as p,o as r,f as d,w as n,a as e,b as i,d as o,c as f,F as x}from"./CR_XfkrP.js";import{_ as L}from"./Apvmmo3P.js";const v=p({__name:"_base",setup(b){const t={webcomponent:"<chi-label>Label</chi-label>",htmlblueprint:'<label class="chi-label">Label</label>'};return(s,l)=>{const a=m,c=u;return r(),d(c,{title:"Base",id:"base"},{example:n(()=>l[0]||(l[0]=[e("chi-label",{for:"input-1"},"Label",-1),e("input",{class:"-sr--only",id:"input-1-control"},null,-1)])),"code-webcomponent":n(()=>[i(a,{class:"html",lang:"html",code:t.webcomponent},null,8,["code"])]),"code-htmlblueprint":n(()=>[i(a,{class:"html",lang:"html",code:t.htmlblueprint},null,8,["code"])]),_:1})}}}),g=p({__name:"_required",setup(b){const t={webcomponent:`<!-- Required -->
