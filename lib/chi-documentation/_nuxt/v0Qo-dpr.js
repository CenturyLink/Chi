...
}`)])])])])])])],-1))],64)}const v={},g=f(v,[["render",b]]),P=p({__name:"index",setup(r){return(e,_)=>{const i=d;return s(),m(i,{title:"Transfer list",description:"Transfer list is used to organize and select items."},{examples:t(()=>[o(a)]),properties:t(()=>[o(g)]),_:1})}}});export{P as default};
