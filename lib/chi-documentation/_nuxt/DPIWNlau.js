import{_}from"./Kk1AK2EI.js";import{_ as m}from"./DZscRdb4.js";import{_ as u}from"./DAVNcaGE.js";import{e as p,f as d,o as r,w as n,b as i,a as e,d as o,c as f,F as x}from"./pInVwq2A.js";import{_ as L}from"./h9qxsaIy.js";const v=p({__name:"_base",setup(b){const t={webcomponent:"<chi-label>Label</chi-label>",htmlblueprint:'<label class="chi-label">Label</label>'};return(s,l)=>{const a=m,c=u;return r(),d(c,{title:"Base",id:"base"},{example:n(()=>l[0]||(l[0]=[e("chi-label",{for:"input-1"},"Label",-1),e("input",{class:"-sr--only",id:"input-1-control"},null,-1)])),"code-webcomponent":n(()=>[i(a,{class:"html",lang:"html",code:t.webcomponent},null,8,["code"])]),"code-htmlblueprint":n(()=>[i(a,{class:"html",lang:"html",code:t.htmlblueprint},null,8,["code"])]),_:1})}}}),g=p({__name:"_required",setup(b){const t={webcomponent:`<!-- Required -->
