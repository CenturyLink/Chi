import{_ as U}from"./HHge0g2Y.js";import{_ as T}from"./C055cWll.js";import{_ as L}from"./DvtYg461.js";import{F as O,a as N,p as A,C as D}from"./DYTabVq1.js";import{e as f,g as j,j as y,v as W,Z as m,_ as C,x as w,o as l,f as x,w as _,a as i,k as c,c as n,l as d,b as u,d as k,F as G}from"./BX7DqjWX.js";const K=h=>" ".repeat(2*h),Y=h=>h.map((e,t)=>`
${K(7)}<a class="chi-dropdown__menu-item${t===0?" -active":""}" href="${e.href}">${e.name}</a>`).join(""),Z=h=>`<footer class="chi-footer" slot="footer">
  ...
  </footer>`,J=h=>`<footer class="chi-footer">
    <div class="chi-footer__content">
      <div class="chi-footer__internal">
        <div class="chi-footer__internal-content -mw--1200">
          <div class="chi-dropdown chi-footer__language">
  ...
  </footer>`,b=(h="lumen",e="language-dropdown-button")=>{switch(h){case"brightspeed":return J(e);case"centurylink":return F(D,h);case"colt":return F(A,h);default:return Z(e)}},H=(h="language-dropdown-button")=>({lumen:b("lumen",h),centurylink:b("centurylink",h),brightspeed:b("brightspeed",h),colt:b("colt",h)}),g=h=>{const e=document.getElementById(h);e&&chi.dropdown(e)},Q={title:"Page Title"},X={class:"-d--inline-flex",slot:"help-icon"},ii={ref:"popover",position:"right-start",variant:"text",arrow:"",reference:"#help-icon__help-button"},ei={slot:"footer"},ci=["innerHTML"],ti=["innerHTML"],li=["innerHTML"],si=["innerHTML"],M="help-icon-language-dropdown-button",ni=f({__name:"_help_icon",setup(h){const e=j("popover"),t=y(),s=H(M);W(async()=>{await m(),g(M)}),C(t,async r=>{await m(),g(M)});const o=()=>{e.value.toggle()},a=w(()=>{const r=b(t.value,M);return{webcomponent:`<chi-main title="Page Title">
