...
</div>`:null},A=(e,n)=>{const l=n.dynamicComputedProps,r="example_id",i=N((l==null?void 0:l.layout)??""),s=T(l,r),t=y(l,r,i),$=w(l),c=[i.percentage,i.gridInput].filter(Boolean).join(" "),u=[...s,c?`class="${c}"`:""],d=L(n,u),g=m(d,4,2),f=d.length>3?"  ":"";let p=$||`<div class="chi-form__item${i.row}${i.grid}">
  ${t}
  <${e}${g}${f}></${e}>
