import{_}from"./CcrI_bxZ.js";import{_ as m}from"./Di-ELn2D.js";import{_ as u}from"./Cx7J_iiN.js";import{e as p,o as r,f as d,w as n,a as e,b as i,d as o,c as f,F as x}from"./CRBsHPO5.js";import{_ as L}from"./D1M_ALV-.js";const v=p({__name:"_base",setup(b){const t={webcomponent:"<chi-label>Label</chi-label>",htmlblueprint:'<label class="chi-label">Label</label>'};return(s,l)=>{const a=m,c=u;return r(),d(c,{title:"Base",id:"base"},{example:n(()=>l[0]||(l[0]=[e("chi-label",{for:"input-1"},"Label",-1),e("input",{class:"-sr--only",id:"input-1-control"},null,-1)])),"code-webcomponent":n(()=>[i(a,{class:"html",lang:"html",code:t.webcomponent},null,8,["code"])]),"code-htmlblueprint":n(()=>[i(a,{class:"html",lang:"html",code:t.htmlblueprint},null,8,["code"])]),_:1})}}}),g=p({__name:"_required",setup(b){const t={webcomponent:`<!-- Required -->
