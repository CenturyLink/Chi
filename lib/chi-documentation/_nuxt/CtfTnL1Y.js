import{_}from"./DZscRdb4.js";import{_ as g}from"./h9qxsaIy.js";import{_ as T}from"./DAVNcaGE.js";import{e as d,g as B,p as H,h as L,f as b,o as r,w as e,b as o,a as t,d as n,j as C,c as w,i as E,t as S,F as y,l as k,k as $}from"./pInVwq2A.js";import{_ as x}from"./Kk1AK2EI.js";const V={class:"-text"},N=["href"],R="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas et interdum purus. Curabitur varius libero, vel hendrerit enim tincidunt sit amet. Ut eros purus, semper nec ipsum et, maximus faucibus suscipit nibh.",W=d({__name:"_long",setup(h){const c=B("longTooltipButton"),p=H().public.baseUrl,a=[{disabled:!0,id:"webcomponent",label:"Web Component"},{active:!0,id:"vue",label:"Vue"},{id:"htmlblueprint",label:"HTML Blueprint"}],i={webcomponent:"",vue:`<ChiTooltip message="Lorem ipsum...">
...
<script>chi.tooltip(document.getElementById('tooltip-long'));<\/script>`};return L(()=>{c.value&&chi.tooltip(c.value)}),(u,l)=>{const s=_,m=g,v=T;return r(),b(v,{title:"Long Tooltips",id:"long",tabs:a},{"example-description":e(()=>[t("p",V,[l[0]||(l[0]=n("Long Tooltips will be truncated on the fourth line. To display text beyond four lines, use the ")),t("a",{href:`${C(p)}components/popover`},"Popover",8,N),l[1]||(l[1]=n(" component"))])]),example:e(()=>[t("button",{class:"chi-button -mr--2 -mb--2 -mb-md--0","data-tooltip":R,ref:"longTooltipButton"},"Hover me to see tooltip",512)]),"code-webcomponent":e(()=>[o(s,{class:"html",lang:"html",code:i.webcomponent},null,8,["code"])]),"code-vue":e(()=>[o(s,{class:"html",lang:"html",code:i.vue},null,8,["code"])]),"code-htmlblueprint":e(()=>[o(m),o(s,{lang:"html",code:i.htmlblueprint},null,8,["code"])]),_:1})}}}),M=d({__name:"_disabled",setup(h){const c=[{active:!0,id:"webcomponent",label:"Web Component"},{id:"vue",label:"Vue"},{id:"htmlblueprint",label:"HTML Blueprint"}],p={webcomponent:`<chi-tooltip message="Tooltip message for a disabled button">
...
<script>chi.tooltip(document.getElementById('tooltip-disabled-button'));<\/script>`};return(a,i)=>{const u=x,l=_,s=g,m=T;return r(),b(m,{title:"Tooltip on disabled buttons",id:"disabled",tabs:c},{example:e(()=>[o(u,null,{default:e(()=>i[0]||(i[0]=[t("chi-tooltip",{message:"Tooltip message for a disabled button",wrapper:""},[t("chi-button",{disabled:""},"Hover me to see tooltip")],-1)])),_:1})]),"code-webcomponent":e(()=>[o(l,{class:"html",lang:"html",code:p.webcomponent},null,8,["code"])]),"code-vue":e(()=>[o(l,{class:"html",lang:"html",code:p.vue},null,8,["code"])]),"code-htmlblueprint":e(()=>[i[1]||(i[1]=t("div",{class:"p--text chi-tab__description"},[n("When a button element is in disabled state, "),t("code",null,"mouseenter"),n(" and "),t("code",null,"mouseleave"),n(" events are not being triggered. Wrap the disabled button in a "),t("code",null,"span"),n(" element, providing the attribute "),t("code",null,'data-tooltip=""'),n(" to achieve the same behavior.")],-1)),o(s),o(l,{lang:"html",code:p.htmlblueprint},null,8,["code"])]),_:1})}}}),J={class:"-bg--black"},I={class:"-p--3"},O=d({__name:"_light-lumen-centurylink",setup(h){const c=[{active:!0,id:"webcomponent",label:"Web Component"},{id:"vue",label:"Vue"},{id:"htmlblueprint",label:"HTML Blueprint"}],p={webcomponent:`<chi-tooltip message="Your tooltip text on a button" color="light">
...
`};return(a,i)=>{const u=x,l=_,s=g,m=T;return r(),b(m,{title:"Base",id:"base",tabs:c},{example:e(()=>[o(u,null,{default:e(()=>i[0]||(i[0]=[t("chi-tooltip",{message:"Your tooltip text on a button",wrapper:""},[t("chi-button",null,"Hover me to see tooltip")],-1)])),_:1})]),"code-webcomponent":e(()=>[o(l,{class:"html",lang:"html",code:p.webcomponent},null,8,["code"])]),"code-vue":e(()=>[o(l,{class:"html",lang:"html",code:p.vue},null,8,["code"])]),"code-htmlblueprint":e(()=>[i[1]||(i[1]=t("div",{class:"p--text chi-tab__description"},[n("To render a tooltip, apply the "),t("code",null,"data-tooltip"),n(" attribute to an element. Then initialize it with the chi.tooltip factory method.")],-1)),o(s),o(l,{lang:"html",code:p.htmlblueprint},null,8,["code"])]),_:1})}}}),K=d({__name:"index",setup(h){const c=k();return(p,a)=>(r(),w(y,null,[a[0]||(a[0]=t("h2",null,"Examples",-1)),o(P),["lumen","centurylink"].includes(C(c))?(r(),b(O,{key:0})):$("",!0),o(M),o(F),o(W)],64))}});export{K as _};
