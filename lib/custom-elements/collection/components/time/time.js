...
export class Time {
    ...
    selectTimeAndPeriod() {
        ...
        if (this.value && this.validateTime(this.value)) {
            const [hourMinSec, period] = (_a = this.value) === null || _a === void 0 ? void 0 : _a.trim().split(' ');
            const [hours, minutes, seconds] = hourMinSec === null || hourMinSec === void 0 ? void 0 : hourMinSec.split(':').map((i) => parseInt(i));
    ...
    render() {
        ...
        return (h("div", { key: '21212d4819cc13bc9400885baed541d96ecc8f4d', class: TIME_CLASSES.TIME }, h("div", { key: '2702e761d234f786ebcf99744c37624ae4bf2b36', class: TIME_CLASSES.CONTENT }, hours, minutes, seconds, periods)));
    }
