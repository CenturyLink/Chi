...
export class Popover {
    ...
    render() {
        ...
        const popoverHeader = this.popoverTitle && (h("header", { key: '01106fdeb7782330eede145171301ce665797662', ref: (el) => (this._popoverHeader = el), class: POPOVER_CLASSES.HEADER }, h("h2", { key: '3d8671939a2cbec6e6cdb50dcdab69b77b90dcae', class: POPOVER_CLASSES.TITLE }, this.popoverTitle)));
        const slot = this.variant && this.variant === 'text' ? (h("p", { class: POPOVER_CLASSES.TEXT }, h("slot", null))) : (h("slot", null));
        const chiFooter = this.popoverFooter && (h("div", { key: '56be87f92940dd50a1dbf3c484db59f1a07755b7', class: POPOVER_CLASSES.FOOTER }, h("slot", { key: '9174bd53f48df528ae35cdd0c9ebf684c0166e62', name: POPOVER_CLASSES.FOOTER })));
        return (h("section", { key: 'b0268284c9db97787dcfc46d646a2c8ba7598b29', class: `
        ...
        `, ref: (el) => (this._popoverElement = el), onClick: () => this.preventAutoClose(), role: "dialog", "aria-modal": "true", "aria-label": this.popoverTitle, "aria-hidden": !this.active }, closeButton, popoverHeader, h("div", { key: '0898c2b0705876f8185625e50fb781f5f1f862d6', class: POPOVER_CLASSES.CONTENT }, slot), chiFooter, this.arrow && h("div", { key: '81f208b5f6d90b33550a5efb026a3b3ac42d5ef5', class: POPOVER_CLASSES.ARROW })));
    }
