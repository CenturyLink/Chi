...
export class Progress {
    ...
    render() {
        return (h("progress", { key: '6593822174094912b1c55f068debe3745b2e011d', "aria-valuenow": this.value || undefined, "aria-valuemax": this.max || undefined, "aria-valuemin": 0, class: this.state ? `-${this.state}` : '', max: this.max || undefined, role: "progressbar", value: this.value }));
    }
