...
export class MarketingIcon {
    ...
    render() {
        return (h("div", { key: 'f971e892f0a8839253b702ff8a9f32b03102b152', class: `chi-marketing-icon ${this.variant} ${this.getClass()} ${this.extraClass ? this.extraClass : ''}` }, h("svg", { key: 'a1e1f8c29d3942431bd55999ded19926a453beab', xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true" }, h("use", { key: '279a17c2f3d4f196e4601531ae22903a7090d0d6', xlinkHref: `#icon-${this.variant}-${this.icon}` }))));
    }
