...
export class ChiPhoneInput {
    ...
    render() {
        ...
        const textInput = (h("chi-text-input", { key: 'b1781f1592bf8d3689e744f0d9266f5ba6d3fee8', id: `${this._uuid}`, type: "tel", state: this.state ? this.state : null, size: this.size, helperMessage: this.helperMessage, disabled: this.disabled, placeholder: this.placeholder, value: this._suffix, onChiChange: this._suffixInputChangeHandler, onChiInput: this._inputHandler, onKeyPress: this._keyPressHandler, onPaste: this._pasteHandler }));
        return (h("div", { key: '3a67340226d2fb5251e09317f1e38a7e58df3b08', class: `${PHONE_INPUT_CLASSES.PHONE_INPUT}` }, dropdown, textInput));
    }
