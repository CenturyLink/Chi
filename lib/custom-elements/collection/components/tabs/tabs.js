...
export class Tabs {
    ...
    render() {
        ...
        return (h(Host, { key: '2b7beb07ef68225938ab72191d81e16f0a6e650e' }, h("ul", { key: 'abb4f6d56eb43a4051d37bea4ed6700c7b863dea', class: `
            ${TABS_CLASSES.TABS}
          ...
          `, ref: (el) => {
                this.ulElement = el;
            }, onMouseLeave: (e) => this.handlerMouseLeave(e, true), role: "tablist" }, tabElements, seeMoreTrigger, slidingBorder), dropdowns, panels));
    }
