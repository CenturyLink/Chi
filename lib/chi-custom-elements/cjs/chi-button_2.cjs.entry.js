...
const Icon = class {
    constructor(hostRef) {
      ...
      <symbol id="icon-${this.icon}" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        this.loadIcon = async () => {
            ...
            try {
                const path = index.getAssetPath(`./icons/${this.icon}.js`);
                const iconModule = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(path)); });
    ...
    render() {
        ...
        return (index.h("div", { key: '46f25b541a8d2f07f7f742253813a72d3aa675b4', class: `chi-icon ${this.getClass()} ${extraClass}` }, index.h("svg", { key: '26fab7a1e79d98d578042f9581729c65e9a6e5cb', xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true" }, index.h("use", { key: '9dafd68945c29815c2699ed8e003df27f4568a09', xlinkHref: '#icon-' + this.icon }))));
    }
