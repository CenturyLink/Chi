...
const Icon = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'd59aaa9e0a2cb417453c62a8c9c4b20db5ce5885', class: `chi-icon ${this.getClass()} ${extraClass}` }, index.h("svg", { key: '192d2c6344fa0d8bfda2700a47cf34f41f0bdbbb', xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true" }, index.h("use", { key: 'ad82917788180a3b2941b57120c5dd1911bf3905', xlinkHref: '#icon-' + this.icon }))));
    }
