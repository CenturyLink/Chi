...
const Icon = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7c3c9be5f46609c6d68f2958c47aa5d81ff1a134', class: `chi-icon ${this.getClass()} ${extraClass}` }, index.h("svg", { key: '6482f911988b4783d5f5206f50d27100ab0068d7', xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true" }, index.h("use", { key: 'df38cb5d6cbe4a37ea9fc58c6ce6c96ad2cfe967', xlinkHref: '#icon-' + this.icon }))));
    }
