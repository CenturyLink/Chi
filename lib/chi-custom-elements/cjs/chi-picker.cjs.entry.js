...
const Picker = class {
    ...
    render() {
        ...
        if (this.helperMessage) {
            fieldSet = (index.h("div", { key: '5181a06a5141203a01864c01c8c16230738496d2', class: classes.INPUT_CLASSES.WRAPPER }, fieldSet, index.h("chi-helper-message", { key: '95940ed910e64567d17f6732f1e3b98ad197214c', state: this.state }, this.helperMessage)));
        }
        return fieldSet;
    }
