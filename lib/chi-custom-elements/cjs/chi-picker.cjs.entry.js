...
const Picker = class {
    ...
    render() {
        ...
        if (this.helperMessage) {
            fieldSet = (index.h("div", { key: 'c0a1abadb09544bb3fefa463fc20879d28b087a3', class: classes.INPUT_CLASSES.WRAPPER }, fieldSet, index.h("chi-helper-message", { key: '543570be86232c0947294fd7d4f45c0860a00a77', state: this.state }, this.helperMessage)));
        }
        return fieldSet;
    }
