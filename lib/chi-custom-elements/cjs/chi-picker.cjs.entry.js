...
const Picker = class {
    ...
    render() {
        ...
        if (this.helperMessage) {
            fieldSet = (index.h("div", { key: '7891394ea6a50bf7ab133178a7c0aab1b1c4a8d9', class: classes.INPUT_CLASSES.WRAPPER }, fieldSet, index.h("chi-helper-message", { key: 'f4e90df8ee5b7fc293fe07ace39fa6aab23d9d10', state: this.state }, this.helperMessage)));
        }
        return fieldSet;
    }
