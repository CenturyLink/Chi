...
const Accordion = class {
    ...
    getAccordionTriggerContent(accordion) {
        ...
        const title = (index.h("div", { class: isLink ? `${classes.LINK_CLASSES.LINK} ${classes.LINK_CLASSES.NO_UNDERLINE}` : classes.ACCORDION_CLASSES.TITLE }, accordion.title));
    ...
    render() {
        var _a;
        return (index.h("div", { key: 'f6d0866189c5d03037aee2420f82c2fe7d7f2ad6', class: this.getAccordionClasses() }, ...(_a = this.accordions) === null || _a === void 0 ? void 0 : _a.map((accordion, index) => this.getAccordionItem(accordion, index))));
    }
