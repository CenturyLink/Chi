...
const Accordion = class {
    ...
    getLinkTrigger(accordion, index$1) {
        const triggerClasses = utils.joinArrayValues([accordion.disabled && classes.DISABLED_CLASS, classes.ACCORDION_CLASSES.TRIGGER_LINK]);
        const content = [index.h("span", null, accordion.title), this.getChevronIcon()];
        return (index.h("div", { class: triggerClasses, onClick: () => this.toggleAccordion(index$1) }, index.h("chi-link", { disabled: accordion.disabled, "no-underline": true }, content)));
    }
    ...
    render() {
        var _a;
        return (index.h("div", { key: '3326d596ea1318b408575ce3d5ba6a336672c0c5', class: this.getAccordionClasses() }, ...(_a = this.accordions) === null || _a === void 0 ? void 0 : _a.map((accordion, index) => this.getAccordionItem(accordion, index))));
    }
