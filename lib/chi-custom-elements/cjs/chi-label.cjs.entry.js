...
const Label = class {
    ...
    render() {
        ...
        return (index.h("label", { key: '84fd5943dc3e584091b50eeaf054186d85a69574', class: `
          ${classes.LABEL_CLASSES.LABEL}
          ${this.size ? `-${this.size}` : ''}
          `, htmlFor: this.for && `${this.for}-control` }, index.h("slot", { key: '563dec680578d895f0dbe9631cd6281d8f5c6ca5' }), message, infoIcon));
    }
