...
const badgeScss = "chi-badge.sc-chi-badge-h{display:-ms-inline-flexbox;display:inline-flex;vertical-align:middle}.sc-chi-badge-s>*>:not(:last-child){margin-right:.5rem}";
const ChiBadgeStyle0 = badgeScss;
