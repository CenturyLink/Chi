...
const Link = class {
    ...
    render() {
        return (index.h("a", Object.assign({ key: '71614a17e06c53e729bb5a7de813c37fe4533e9f', class: `${classes.LINK_CLASSES.LINK}
          ${this.cta ? '-cta' : ''}
          ${this.disabled ? '-disabled' : ''}
          ${this.size ? `-${this.size}` : ''}
          ${this._hover ? `-hover` : ''}
          ${this.noUnderline ? classes.LINK_CLASSES.NO_UNDERLINE : ''}
          ${this.noHoverUnderline ? '-no-hover-underline' : ''}`, href: this.href, hreflang: this.hreflang, target: this.target, rel: this.rel, download: this.download }, (this.alternativeText && { 'aria-label': this.alternativeText })), index.h("div", { key: '89ce7835af7541dc5a003ff5593a0a94971a3f0e', class: `${this._hasIcon() ? classes.LINK_CLASSES.CONTENT : ''}` }, index.h("slot", { key: '1e840c4212aadd932030265678be1a819362a52c' }))));
    }
