...
const SearchInput = class {
    ...
    render() {
        const isAutocomplete = this._isAutocomplete();
        const searchInputElement = (index.h("input", { key: 'cbf76b882d89da8f5c484b13f7af92cb8284dd6b', type: "search", class: `
        ...
        const searchIcon = (index.h("button", { key: '779d1da1d320ffc08fc8a23729f34faf320ceda9', class: `
        chi-button -icon -flat -bg--none
        ${this.size ? `-${this.size}` : ''}
        `, onClick: () => this.eventSearch.emit(this.value), "aria-label": "Search" }, index.h("div", { key: 'e0af08940f4eb064698e84956fcb2e6f9efc59e4', class: "chi-button__content" }, index.h("i", { key: 'a5ccaf65b0c27c83e06bf2dcf2f7e55ac2aa6e8c', class: 'chi-icon icon-search', "aria-hidden": "true" }))));
        const input = (index.h("div", { key: '6dfba4b9cfa3dad77d88c70ba95c5d29ed5c94fe', class: "chi-input__wrapper -icon--right", slot: "trigger" }, searchInputElement, searchXIcon, searchIcon));
