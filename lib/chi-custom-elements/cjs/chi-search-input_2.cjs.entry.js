...
const SearchInput = class {
    ...
    render() {
        ...
        const searchIcon = (index.h("button", { key: 'ba9bb7b982a796d520c02cebf401fba5e8a604f1', class: `
        chi-button -icon -flat -bg--none
        ${this.size ? `-${this.size}` : ''}
        `, onClick: () => this.eventSearch.emit(this.value), "aria-label": "Search" }, index.h("div", { key: '62034891e383de69a477ecdd55cb847f1143ec3f', class: "chi-button__content" }, index.h("i", { key: '174fe87088f8aa695dd1edf07ce3e1a082487c09', class: 'chi-icon icon-search', "aria-hidden": "true" }))));
        const input = (index.h("div", { key: '3273df48befc20f84c7d9a95c2f9b0be9594e9a8', class: "chi-input__wrapper -icon--right", slot: "trigger" }, searchInputElement, searchXIcon, searchIcon));
