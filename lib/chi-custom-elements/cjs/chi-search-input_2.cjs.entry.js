...
const SearchInput = class {
    ...
    render() {
        ...
        const searchIcon = (index.h("button", { key: 'fdfca1aadefa4ebbe46395e435d45fc63657b7b4', class: `
        chi-button -icon -flat -bg--none
        ${this.size ? `-${this.size}` : ''}
        `, onClick: () => this.eventSearch.emit(this.value), "aria-label": "Search" }, index.h("div", { key: '2aa85a7c02558675df534dda150891162ad77e3a', class: "chi-button__content" }, index.h("i", { key: '06e222e78de86b74bd6035996b8a9f49c2f74e35', class: 'chi-icon icon-search', "aria-hidden": "true" }))));
        const input = (index.h("div", { key: '6c1875682bd7db4bfdc0dec3ee5e6fb689553188', class: "chi-input__wrapper -icon--right", slot: "trigger" }, searchInputElement, searchXIcon, searchIcon));
