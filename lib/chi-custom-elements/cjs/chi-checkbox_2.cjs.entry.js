...
const Checkbox = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7bc76af1d57c2614ae20122ea2b498d4c3068aab', class: classes.CHECKBOX_CLASSES.checkbox }, input, label, index.h("slot", { key: '58e3ecbd06a40ce0980497e937a51a18ae7cf9f1', name: "chi-checkbox__help" })));
    }
...
const dropdownScss = "chi-dropdown.sc-chi-dropdown-h{display:-ms-flexbox;display:flex}";
const ChiDropdownStyle0 = dropdownScss;
...
const Dropdown = class {
    ...
    renderDropdownMenuHeader() {
        const headerContent = index.h("slot", { name: "menu-header" });
    ...
    renderMenu() {
        ...
        return (index.h("div", { class: `
          ...
          ${this.active ? classes.ACTIVE_CLASS : ''}
          ${this._fluidClass}
          ${this.description ? classes.LIST_CLASS : ''}`, ref: (ref) => (this._dropdownMenuElement = ref) }, this.renderDropdownMenuHeader(), this.renderDropdownMenuItems(isMultiItems), this.renderDropdownMenuFooter(isMultiItems)));
    }
