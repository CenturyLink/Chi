...
const Popover = class {
    ...
    __stencil_render() {
        ...
        const popoverHeader = this.popoverTitle && (index.h("header", { key: '7477bf7fe6378df41c7fe58e0195b635a02e53f3', ref: (el) => (this._popoverHeader = el), class: classes.POPOVER_CLASSES.HEADER }, index.h("h2", { key: '24728d59f0ffbcd6ef00b96192b5e23d0af6b0e9', class: classes.POPOVER_CLASSES.TITLE }, this.popoverTitle)));
        ...
        const chiFooter = this.popoverFooter && (index.h("div", { key: 'fc5073cca2c990891cee4ea0e60ba5d8ce6c7692', class: classes.POPOVER_CLASSES.FOOTER }, index.h("slot", { key: '88d3766aef3cbb90f5586d7216d00a4789cfa5ee', name: classes.POPOVER_CLASSES.FOOTER })));
        return (index.h("section", { key: '5055aa8ebd59090f61eb59dd4d5dc86f61e28a4e', class: `
        ...
        `, ref: (el) => (this._popoverElement = el), onClick: () => this.preventAutoClose(), role: "dialog", "aria-modal": "true", "aria-label": this.popoverTitle, "aria-hidden": !this.active }, closeButton, popoverHeader, index.h("div", { key: '41308f75020312442567628bd6ee6a8a7393b052', class: classes.POPOVER_CLASSES.CONTENT }, slot), chiFooter, this.arrow && index.h("div", { key: '12b406fa5db87992513dde477603b1c54bc645ea', class: classes.POPOVER_CLASSES.ARROW })));
    }
