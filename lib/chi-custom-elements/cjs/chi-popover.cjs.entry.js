...
const Popover = class {
    ...
    __stencil_render() {
        ...
        const popoverHeader = this.popoverTitle && (index.h("header", { key: 'f8d4e6264b68beda229165cf36dcb4a1be874b2d', ref: (el) => (this._popoverHeader = el), class: classes.POPOVER_CLASSES.HEADER }, index.h("h2", { key: '1f5ce74f43d93f58890d09a10551687aabf9d979', class: classes.POPOVER_CLASSES.TITLE }, this.popoverTitle)));
        ...
        const chiFooter = this.popoverFooter && (index.h("div", { key: 'b8af9d1d244c39d3acaae05bfdea6f9ce1068f75', class: classes.POPOVER_CLASSES.FOOTER }, index.h("slot", { key: 'cda8cadc72598865da889afcd3fc5c22149973ac', name: classes.POPOVER_CLASSES.FOOTER })));
        return (index.h("section", { key: '80f7cc58ae33e683a8a074de76ac98752207e207', class: `
        ...
        `, ref: (el) => (this._popoverElement = el), onClick: () => this.preventAutoClose(), role: "dialog", "aria-modal": "true", "aria-label": this.popoverTitle, "aria-hidden": !this.active }, closeButton, popoverHeader, index.h("div", { key: '5e7c321a64b5b8761bd07666d531df57d35ebf40', class: classes.POPOVER_CLASSES.CONTENT }, slot), chiFooter, this.arrow && index.h("div", { key: '821d2056c7465a1489c970f9c81d372a5695a8b6', class: classes.POPOVER_CLASSES.ARROW })));
    }
