...
const Popover = class {
    ...
    __stencil_render() {
        ...
        const popoverHeader = this.popoverTitle && (index.h("header", { key: '4d1c96ec8c0cb3537dc7e09c9fa1646a593968aa', ref: (el) => (this._popoverHeader = el), class: classes.POPOVER_CLASSES.HEADER }, index.h("h2", { key: '9426b059b5833bbb1199981958c83de0da40eb26', class: classes.POPOVER_CLASSES.TITLE }, this.popoverTitle)));
        ...
        const chiFooter = this.popoverFooter && (index.h("div", { key: 'ddcabbd4f70d83e11bb4a2b3fdbbad4861f3d14b', class: classes.POPOVER_CLASSES.FOOTER }, index.h("slot", { key: '7c0e6db0611fe48c41eaede6fbf2aa50a4081e5a', name: classes.POPOVER_CLASSES.FOOTER })));
        return (index.h("section", { key: '21bf6599172ad4c02583161206195ce0c72c171d', class: `
        ...
        `, ref: (el) => (this._popoverElement = el), onClick: () => this.preventAutoClose(), role: "dialog", "aria-modal": "true", "aria-label": this.popoverTitle, "aria-hidden": !this.active }, closeButton, popoverHeader, index.h("div", { key: '31eff87c6abb64a1c880add08556c8476f534895', class: classes.POPOVER_CLASSES.CONTENT }, slot), chiFooter, this.arrow && index.h("div", { key: '36c40342de0a171b5a296f7307492376e349e759', class: classes.POPOVER_CLASSES.ARROW })));
    }
