...
const Tooltip = class {
    ...
    render() {
        return (index.h("div", { key: 'a2b15e0c5e5136a14b8d30bba499827833327395', class: this.wrapper ? classes.TOOLTIP_CLASSES.WRAPPER : '', ref: (el) => (this._tooltipRef = el), "aria-describedby": this.tooltipVisible ? this._id : null }, index.h("slot", { key: 'de2f5fdb53df3b7ac30c1ec474577c28b9b73c78' }), index.h("div", { key: '1e13a22ef3b27a9525b7221bcdc025170b6bcd1f', class: {
                [classes.TOOLTIP_CLASSES.ELEMENT]: true,
                [classes.LIGHT_CLASS]: this.color === 'light',
            }, id: this._id, role: "tooltip", ref: (el) => (this._tooltipElementNode = el), "aria-hidden": !this.tooltipVisible }, index.h("span", { key: '76c5fb50ac740c61beb8293bb7dfceb4bfa68d02', class: classes.TOOLTIP_CLASSES.MESSAGE }, this.message))));
    }
