...
const Progress = class {
    ...
    render() {
        return (index.h("progress", { key: '21c4b23a8e28e5e54bbb385ed1a95cd3001c84bf', "aria-valuenow": this.value || undefined, "aria-valuemax": this.max || undefined, "aria-valuemin": 0, class: this.state ? `-${this.state}` : '', max: this.max || undefined, role: "progressbar", value: this.value }));
    }
