...
const TimePicker = class {
    ...
    render() {
        const chiPopover = (index.h("chi-popover", { key: '10a8d08251e7687609d0cbb13d9e7fe62ceca0b5', id: `popover-${this._uuid}`, position: "bottom", reference: `#${this._uuid}-control`, "prevent-auto-hide": true, active: this.active }, index.h("chi-time", { key: '155ee779c75796489810a3407c66b16c2d60faaa', "display-seconds": this.displaySeconds, "excluded-hours": this._excludedHours, "excluded-minutes": this._excludedMinutes, "excluded-seconds": this._excludedSeconds, format: this.format, value: this.value, "seconds-step": this.secondsStep, "minutes-step": this.minutesStep })));
        return (index.h("div", { key: 'ca8600cf33ebaead86239ac3ce0305dff171ecfe', class: this.disabled ? '-disabled' : '' }, index.h("div", { key: '2baa11e6148a55bfc2773867a5274335efb577ec', class: "chi-input__wrapper -icon--right" }, index.h("input", { key: 'd2a138bca73ce8bba7009fca92da73e0b0928bd0', id: `${this._uuid}-control`, class: `chi-input
              ${this.active ? '-focus' : ''}`, type: `text`, placeholder: this.format === '12hr' ? '--:-- --' : '--:--', ref: (el) => (this._input = el), value: this.value, disabled: this.disabled }), index.h("chi-icon", { key: 'b1f8b9557b9e660040715cf70b7a4d780b19a593', icon: "circle-clock-outline" })), !this.disabled && chiPopover));
    }
