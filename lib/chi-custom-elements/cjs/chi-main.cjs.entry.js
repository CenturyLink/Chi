...
const appLayoutCss = "chi-main.sc-chi-main-h .chi-main.sc-chi-main{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column}chi-main.sc-chi-main-h .chi-main.sc-chi-main .chi-main__content.sc-chi-main{-ms-flex-positive:1;flex-grow:1}";
...
const AppLayout = class {
    ...
    render() {
        ...
        const appLayoutPageLevelActions = this.appLayoutPageLevelActions && (index.h("div", { key: '8e08e45e83db11af7ec74d12bbb02e119998c079', class: "-d--flex -align-items--center -justify-content--end -py--3 -my--2 -bt--1" }, index.h("slot", { key: 'cc55aff357432768fc170d1a170f6581b5eed020', name: "page-level__actions" })));
