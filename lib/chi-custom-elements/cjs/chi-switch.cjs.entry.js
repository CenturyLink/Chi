...
const ToggleSwitch = class {
    ...
    render() {
        return (index.h("label", { key: 'ca3920311617baba68dc2d6ebb493597b4504afe', htmlFor: `${this.el.id}-control`, class: `chi-switch
              ${this.size ? `-${this.size}` : ''}
              ${this.hideLabel ? '-label--hide' : ''}` }, index.h("input", { key: '4d6552f624ae32c778420ccdde51a24ae745df10', type: "checkbox", class: `chi-switch__input ${this.extraClass ? this.extraClass : ''}`, id: `${this.el.id}-control`, disabled: this.disabled, checked: this.checked, onClick: () => this._toggle() }), index.h("span", { key: '643a3221e48f60821c6d3fef25054f2f6d62f05c', class: "chi-switch__content" }, index.h("span", { key: '768d1827bc9f6f27c4e0acb616ff1d54609d4774', class: "chi-switch__thumb" })), index.h("span", { key: '8bbcef2e87a279fadf401f6caf3b276136715a2f', class: "chi-switch__label" }, this.label)));
    }
