...
const FormWrapper = class {
    ...
    render() {
        ...
        if (this.helperMessage) {
            fieldSet = (index.h("div", { key: '67dc9427e209f9e1048ba72dc1d258a42ab6cf00', class: classes.INPUT_CLASSES.WRAPPER }, fieldSet, index.h("chi-helper-message", { key: 'dc2481837ff546b6edbed47abefdd4a320310fd8', state: this.state }, this.helperMessage)));
        }
        return fieldSet;
    }
