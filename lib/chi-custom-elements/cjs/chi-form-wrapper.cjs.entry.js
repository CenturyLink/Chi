...
const FormWrapper = class {
    ...
    render() {
        ...
        if (this.helperMessage) {
            fieldSet = (index.h("div", { key: '9d25a809a1ff5f961d65d17176381073a33e307e', class: classes.INPUT_CLASSES.WRAPPER }, fieldSet, index.h("chi-helper-message", { key: '513b7d099c074d42155a8d302c7713258dd10135', state: this.state }, this.helperMessage)));
        }
        return fieldSet;
    }
