...
const Modal = class {
    constructor(hostRef) {
        ...
        this.getAlertContent = () => (index.h("div", { class: classes.UTILITY_CLASSES.DISPLAY.FLEX }, index.h("chi-icon", { icon: "circle-x", size: "sm--3", color: "danger", class: MARGIN.RIGHT[2] }), index.h("div", { class: classes.UTILITY_CLASSES.SIZING.W100 }, index.h("p", { class: `${TYPOGRAPHY.TEXT_BOLD} ${MARGIN[0]}` }, index.h("slot", { name: "alert-subhead" }, "Subhead")), index.h("slot", { name: "content" }, index.h("p", { class: `${MARGIN.TOP[1]} ${MARGIN.BOTTOM[0]}` }, constants.MODAL_CONTENT_DEFAULT_MESSAGE)))));
        this.getSimpleContent = () => (index.h("div", null, index.h("h2", { class: `${TYPOGRAPHY.TEXT_H3} ${TYPOGRAPHY.TEXT_BOLDER} ${MARGIN[0]}` }, this.modalTitle), index.h("slot", { name: "content" }, index.h("p", { class: `${TYPOGRAPHY.TEXT} ${classes.UTILITY_CLASSES.PADDING.Y[1]} ${classes.UTILITY_CLASSES.PADDING.X[3]}` }, constants.MODAL_CONTENT_DEFAULT_MESSAGE)), index.h("slot", { name: "footer" }, index.h("chi-button", { color: "primary", size: "lg", class: MARGIN.TOP[1], onClick: () => this.accept() }, "Action"))));
        this.getDefaultContent = () => (index.h("slot", { name: "content" }, index.h("p", { class: `${TYPOGRAPHY.TEXT} ${MARGIN[0]}` }, constants.MODAL_CONTENT_DEFAULT_MESSAGE)));
    ...
    getContent() {
        ...
        return (index.h("div", { class: classes$1 }, this.alert && this.getAlertContent(), this.simple && this.getSimpleContent(), !this.simple && !this.alert && this.getDefaultContent()));
    }
    getHeader() {
    ...
    render() {
        ...
        return (index.h("div", { key: 'e9278dcde5332d2f0b91816599736a78fb397d2e' }, !this.target && this.getTrigger(), index.h("div", { key: '36d0be566c4c447cae6746d17d0c1db04ccb7885', class: this.getBackdropClasses() }, index.h("div", { key: 'd622920538fee029429f13227cac45277d4757e9', class: classes.BACKDROP_CLASSES.WRAPPER }, index.h("section", Object.assign({ key: '9221796ccb0f4f84932160d13fc0251c42adb858' }, sectionAttributes), !this.simple && this.getHeader(), this.simple && this.getCloseButton(), this.getContent(), !this.simple && this.getFooter())))));
    }
