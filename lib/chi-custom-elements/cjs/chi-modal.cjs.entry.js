...
const Modal = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '9c657d10d5323ada0200b32ffd9f67f559318808' }, !this.target && this.getTrigger(), index.h("div", { key: '5da143e2d17ed037d79660432410f08a4064abb8', class: this.getBackdropClasses() }, index.h("div", { key: '09ef547d12ec7a289bc14a6e39c35fbd8d778ae1', class: classes.BACKDROP_CLASSES.WRAPPER }, index.h("section", Object.assign({ key: '9ad1466701de1700535c0c063485706c5f7e79da' }, sectionAttributes), !this.simple && this.getHeader(), this.getContent(), !this.simple && this.getFooter())))));
    }
