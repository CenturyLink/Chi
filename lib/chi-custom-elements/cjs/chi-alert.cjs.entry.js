...
const Alert = class {
    ...
    render() {
        ...
        const chiIcon = !this.spinner && this.icon && (index.h("chi-icon", { key: 'df813e62f929d66f24daec8edd57543d5f260a43', icon: this.icon, color: this.color || null, extraClass: "chi-alert__icon" }));
        const alertTitle = this.alertTitle ? index.h("p", { class: "chi-alert__title" }, this.alertTitle) : '';
        const chiActions = this._hasAlertActions() && (index.h("div", { key: 'a48edb17aeb1cb0910dbe2b774f87ff9b9d0bf1a', class: "chi-alert__actions" }, index.h("slot", { key: 'b3181632d6cef90b09194258fb25e8a6d034ceb0', name: "chi-alert__actions" })));
        const chiSpinner = this.spinner && (index.h("chi-spinner", { key: '5640c6c4ee9f937fcbde914d7a4cd86726239d32', class: "chi-alert__spinner", size: spinnerSizeMapping[this.size] || 'sm' }));
        const chiClickableIcon = this._hasClickableIcon() && (index.h("div", { key: '3b012e8242f8dbd2b3dcd53a13e4e7cf7e68125a', class: "chi-alert__clickable-icon" }, index.h("slot", { key: '01990a0ce88703f05ff57da68b49685666c1228d', name: "chi-alert__clickable-icon" })));
        const chiButton = (this.closable || this.type === 'toast') && (index.h("chi-button", { key: 'b9326048d949fc5e06d5a80bbddc18cee723e96c', extraClass: "chi-alert__close-button", type: "close", onChiClick: () => this._dismissAlert() }));
        return (index.h("div", { key: '7c61971970ecf9838f2036fd4daa28de6856b877', class: `chi-alert
        ${this.type ? `-${this.type}` : ''}
        ${this.color ? `-${this.color}` : ''}
        ${this.center ? '-center' : ''}
        ${this.closable ? '-close' : ''}
        ${this.size ? `-${this.size}` : ''}`, role: "alert" }, chiIcon, chiSpinner, index.h("div", { key: '17a20e4f413b6cdf2cd61ed9a9294330d4567bc6', class: "chi-alert__content" }, alertTitle, index.h("p", { key: '8b030566812f01c625641afd87bd50d2ab7e4184', class: "chi-alert__text" }, index.h("slot", { key: '3187463cd0ae7760898601973de259009cb70a7a' })), chiActions), chiButton, chiClickableIcon));
    }
