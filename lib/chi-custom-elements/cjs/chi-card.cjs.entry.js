...
const Card = class {
    ...
    render() {
        return (index.h("div", { key: '3010ff3ca2a5d895c09c2dad9b154e74b941ca85', class: this.getCardClasses() }, this.getHeroImage(), this.getHeader(), this.getContent(), this.getFooter()));
    }
