...
const customParseFormat = require('./customParseFormat-402e83dc.js');
...
const Date = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ef87fa56813847ba213182c91fbeb462d620cf39', class: `${classes.DATEPICKER_CLASSES.DATEPICKER} ${this._vm.weekStartClass} ${this._vm.monthStartClass}` }, index.h("div", { key: '3a5a8abf30cc8e1c6bd85c1d3ada9da5ad87dbbf', class: `${classes.DATEPICKER_CLASSES.MONTH_ROW}` }, index.h("div", { key: 'dee4d86badc0eaa5cefbb32b4f9f84ac23d04e99', class: `${classes.DATEPICKER_CLASSES.PREV_MONTH} ${prevMonthDisabled ? constants.CLASSES.DISABLED : ''}`, tabindex: "0", onClick: () => this.prevMonth() }, index.h("chi-icon", { key: '943a25c8b94fc9a192bbcbd86f118bf0172349e0', icon: "chevron-left", size: "sm" })), index.h("div", { key: '2c3cd4d15a0b6235aff6684f522b3f54b1e1476d', class: `${classes.DATEPICKER_CLASSES.MONTH}` }, `${this.viewMonth.format('MMMM')}
              ${this.viewMonth.format('YYYY')}`), index.h("div", { key: '11d7a36eb0fa196d61537b8179def4a374c3f115', class: `${classes.DATEPICKER_CLASSES.NEXT_MONTH} ${nextMonthDisabled ? constants.CLASSES.DISABLED : ''}`, tabindex: !nextMonthDisabled ? '0' : '', onClick: () => this.nextMonth() }, index.h("chi-icon", { key: '4df626018222899cd91822a7c6b6d9220e903c7d', icon: "chevron-right", size: "sm" }))), index.h("div", { key: '610a00ac22028b20d0b6bd39e5a8e688ad73006f', class: `${classes.DATEPICKER_CLASSES.DAY_NAMES}` }, this._vm.weekDays.map((weekDay) => (index.h("div", { class: `${classes.DATEPICKER_CLASSES.WEEK_DAY}`, key: weekDay.format('dddd') }, weekDay.format('dddd').substr(0, 1))))), index.h("div", { key: '883f62b376bc207ad36bba54236e6728e0cb0327', class: `${classes.DATEPICKER_CLASSES.DAYS}` }, this._vm.monthDays.map((day) => {
