...
const customParseFormat = require('./customParseFormat-cd021633.js');
...
const Date = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3e3ccec83955b05baac1ed85b5ef1de240b53c2f', class: `${classes.DATEPICKER_CLASSES.DATEPICKER} ${this._vm.weekStartClass} ${this._vm.monthStartClass}` }, index.h("div", { key: '8db117106b6dd557b9ac2b551f94de0b10d2bfe3', class: `${classes.DATEPICKER_CLASSES.MONTH_ROW}` }, index.h("div", { key: 'e40fe2bf858efbf5332f21049de0773702a4d6b5', class: `${classes.DATEPICKER_CLASSES.PREV_MONTH} ${prevMonthDisabled ? constants.CLASSES.DISABLED : ''}`, tabindex: "0", onClick: () => this.prevMonth() }, index.h("chi-icon", { key: 'aedad6f8f57a6893182c0148fd660ef36738d5ea', icon: "chevron-left", size: "sm" })), index.h("div", { key: '0f6225edb7f30ed41275dbf8dabfc4ed10252730', class: `${classes.DATEPICKER_CLASSES.MONTH}` }, `${this.viewMonth.format('MMMM')}
              ${this.viewMonth.format('YYYY')}`), index.h("div", { key: 'a4c2a6c1fbef66bd35147ac835d09f2f202c07b8', class: `${classes.DATEPICKER_CLASSES.NEXT_MONTH} ${nextMonthDisabled ? constants.CLASSES.DISABLED : ''}`, tabindex: !nextMonthDisabled ? '0' : '', onClick: () => this.nextMonth() }, index.h("chi-icon", { key: 'ec64316f7fdeb69a303b08cfff7198e578860a10', icon: "chevron-right", size: "sm" }))), index.h("div", { key: 'ccb985de39189f169d10a059735e2f241efa70da', class: `${classes.DATEPICKER_CLASSES.DAY_NAMES}` }, this._vm.weekDays.map((weekDay) => (index.h("div", { class: `${classes.DATEPICKER_CLASSES.WEEK_DAY}`, key: weekDay.format('dddd') }, weekDay.format('dddd').substr(0, 1))))), index.h("div", { key: 'a42635766a5f311f07c01293715e84827d4a2194', class: `${classes.DATEPICKER_CLASSES.DAYS}` }, this._vm.monthDays.map((day) => {
