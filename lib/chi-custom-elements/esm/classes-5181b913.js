...
const LINK_CLASSES = {
    LINK: 'chi-link',
    CONTENT: 'chi-link__content',
    NO_UNDERLINE: '-no-underline',
    NO_HOVER_UNDERLINE: '-no-hover-underline',
    CTA: '-cta',
};
//#endregion
//#region Stat
...
const CARD_CLASSES = {
    CARD: 'chi-card',
    CONTENT: 'chi-card__content',
    CAPTION: 'chi-card__caption',
    HEADER: 'chi-card__header',
    FOOTER: 'chi-card__footer',
    TITLE: 'chi-card__title',
    ACTIONS: 'chi-card__actions',
    HERO: 'chi-card__hero',
    WIDGET: '-widget',
};
//#endregion
...
export { LIST_CLASS as $, ACCORDION_CLASSES as A, BACKDROP_CLASSES as B, CARD_CLASS as C, DISABLED_CLASS as D, EXPANDED_CLASS as E, FORM_CLASSES as F, GENERIC_SIZE_CLASSES as G, HIGHLIGHT_CLASS as H, ICON_CLASS as I, GRID_CLASSES as J, TAGS_CLASSES as K, LINK_CLASSES as L, MODAL_CLASSES as M, NO_BORDER_CLASS as N, DATEPICKER_CLASSES as O, PHONE_INPUT_CLASSES as P, INACTIVE_CLASS as Q, ROW_CLASS as R, STAT_CLASSES as S, TRUNCATED_CLASS as T, UTILITY_CLASSES as U, RADIO_CLASSES as V, LABEL_CLASSES as W, SR_ONLY as X, CHECKBOX_CLASSES as Y, FLUID_CLASS as Z, ANIMATE_CLASS as _, CARD_CLASSES as a, DIVIDER_CLASSES as a0, TOOLTIP_CLASSES as a1, LIGHT_CLASS as a2, STATUS_CLASS as a3, POPOVER_CLASSES as a4, ACTIVE_CLASS as b, EMPTY_CLASS as c, TRANSITIONING_CLASS as d, CAROUSEL_CLASSES as e, TIME_CLASSES as f, EPANEL_CLASSES as g, ICONS as h, FORM_WRAPPER_CLASSES as i, INPUT_CLASSES as j, HOVER_CLASS as k, CLOSED_CLASS as l, CENTERED_CLASS as m, CENTER_CLASS as n, INVERSE_CLASS as o, ANIMATED_CLASS as p, DROPDOWN_CLASSES as q, BUTTON_CLASSES as r, PICKER_CLASSES as s, PILL_CLASS as t, PRICE_CLASSES as u, SKELETON_CLASSES as v, ROUNDED_CLASS as w, CIRCLE_CLASS as x, SQUARE_CLASS as y, TABS_CLASSES as z };
