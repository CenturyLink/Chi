...
import { L as LABEL_CLASSES } from './classes-6227bd8c.js';
import { v as v4 } from './v4-a4ec28c0.js';

const labelScss = "chi-label.sc-chi-label-h{display:-ms-flexbox;display:flex}";
const ChiLabelStyle0 = labelScss;
