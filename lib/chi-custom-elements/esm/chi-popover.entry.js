...
import { a4 as POPOVER_CLASSES } from './classes-5181b913.js';
...
const Popover = class {
    ...
    __stencil_render() {
        ...
        const popoverHeader = this.popoverTitle && (h("header", { key: '7477bf7fe6378df41c7fe58e0195b635a02e53f3', ref: (el) => (this._popoverHeader = el), class: POPOVER_CLASSES.HEADER }, h("h2", { key: '24728d59f0ffbcd6ef00b96192b5e23d0af6b0e9', class: POPOVER_CLASSES.TITLE }, this.popoverTitle)));
        const slot = this.variant && this.variant === 'text' ? (h("p", { class: POPOVER_CLASSES.TEXT }, h("slot", null))) : (h("slot", null));
        const chiFooter = this.popoverFooter && (h("div", { key: 'fc5073cca2c990891cee4ea0e60ba5d8ce6c7692', class: POPOVER_CLASSES.FOOTER }, h("slot", { key: '88d3766aef3cbb90f5586d7216d00a4789cfa5ee', name: POPOVER_CLASSES.FOOTER })));
        return (h("section", { key: '5055aa8ebd59090f61eb59dd4d5dc86f61e28a4e', class: `
        ...
        `, ref: (el) => (this._popoverElement = el), onClick: () => this.preventAutoClose(), role: "dialog", "aria-modal": "true", "aria-label": this.popoverTitle, "aria-hidden": !this.active }, closeButton, popoverHeader, h("div", { key: '41308f75020312442567628bd6ee6a8a7393b052', class: POPOVER_CLASSES.CONTENT }, slot), chiFooter, this.arrow && h("div", { key: '12b406fa5db87992513dde477603b1c54bc645ea', class: POPOVER_CLASSES.ARROW })));
    }
