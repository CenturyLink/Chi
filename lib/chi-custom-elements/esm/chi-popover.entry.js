...
import { a3 as POPOVER_CLASSES } from './classes-26189a5f.js';
...
const Popover = class {
    ...
    __stencil_render() {
        ...
        const popoverHeader = this.popoverTitle && (h("header", { key: '4d1c96ec8c0cb3537dc7e09c9fa1646a593968aa', ref: (el) => (this._popoverHeader = el), class: POPOVER_CLASSES.HEADER }, h("h2", { key: '9426b059b5833bbb1199981958c83de0da40eb26', class: POPOVER_CLASSES.TITLE }, this.popoverTitle)));
        const slot = this.variant && this.variant === 'text' ? (h("p", { class: POPOVER_CLASSES.TEXT }, h("slot", null))) : (h("slot", null));
        const chiFooter = this.popoverFooter && (h("div", { key: 'ddcabbd4f70d83e11bb4a2b3fdbbad4861f3d14b', class: POPOVER_CLASSES.FOOTER }, h("slot", { key: '7c0e6db0611fe48c41eaede6fbf2aa50a4081e5a', name: POPOVER_CLASSES.FOOTER })));
        return (h("section", { key: '21bf6599172ad4c02583161206195ce0c72c171d', class: `
        ...
        `, ref: (el) => (this._popoverElement = el), onClick: () => this.preventAutoClose(), role: "dialog", "aria-modal": "true", "aria-label": this.popoverTitle, "aria-hidden": !this.active }, closeButton, popoverHeader, h("div", { key: '31eff87c6abb64a1c880add08556c8476f534895', class: POPOVER_CLASSES.CONTENT }, slot), chiFooter, this.arrow && h("div", { key: '36c40342de0a171b5a296f7307492376e349e759', class: POPOVER_CLASSES.ARROW })));
    }
