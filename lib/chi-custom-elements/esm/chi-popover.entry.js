import { r as registerInstance, c as createEvent, h, g as getElement, H as Host } from './index-cde0ed0d.js';
...
import { c as CLASSES, A as ANIMATION_DURATION, E as ESCAPE_KEYCODE } from './constants-76e3b213.js';
import { P as Popper } from './popper-b075152d.js';
import { $ as POPOVER_CLASSES } from './classes-fca9c660.js';
...
const Popover = class {
    ...
    __stencil_render() {
        ...
        const popoverHeader = this.popoverTitle && (h("header", { key: 'f8d4e6264b68beda229165cf36dcb4a1be874b2d', ref: (el) => (this._popoverHeader = el), class: POPOVER_CLASSES.HEADER }, h("h2", { key: '1f5ce74f43d93f58890d09a10551687aabf9d979', class: POPOVER_CLASSES.TITLE }, this.popoverTitle)));
        const slot = this.variant && this.variant === 'text' ? (h("p", { class: POPOVER_CLASSES.TEXT }, h("slot", null))) : (h("slot", null));
        const chiFooter = this.popoverFooter && (h("div", { key: 'b8af9d1d244c39d3acaae05bfdea6f9ce1068f75', class: POPOVER_CLASSES.FOOTER }, h("slot", { key: 'cda8cadc72598865da889afcd3fc5c22149973ac', name: POPOVER_CLASSES.FOOTER })));
        return (h("section", { key: '80f7cc58ae33e683a8a074de76ac98752207e207', class: `
        ...
        `, ref: (el) => (this._popoverElement = el), onClick: () => this.preventAutoClose(), role: "dialog", "aria-modal": "true", "aria-label": this.popoverTitle, "aria-hidden": !this.active }, closeButton, popoverHeader, h("div", { key: '5e7c321a64b5b8761bd07666d531df57d35ebf40', class: POPOVER_CLASSES.CONTENT }, slot), chiFooter, this.arrow && h("div", { key: '821d2056c7465a1489c970f9c81d372a5695a8b6', class: POPOVER_CLASSES.ARROW })));
    }
