...
import { U as UTILITY_CLASSES } from './classes-6227bd8c.js';

const textareaScss = "chi-textarea.sc-chi-textarea-h{display:block;width:100%}";
const ChiTextareaStyle0 = textareaScss;
