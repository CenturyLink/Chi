...
import { L as LABEL_CLASSES, U as UTILITY_CLASSES, K as SR_ONLY, O as CHECKBOX_CLASSES, Q as FLUID_CLASS, c as ACTIVE_CLASS, n as DROPDOWN_CLASSES, V as ANIMATE_CLASS, W as LIST_CLASS, X as DIVIDER_CLASSES } from './classes-fca9c660.js';
...
const Dropdown = class {
    ...
    renderDropdownMenuHeader(isMultiItems) {
        const headerContent = isMultiItems ? this.renderSelectMultiHeaderContent() : h("slot", { name: "menu-header" });
    ...
    renderMenu() {
        ...
        return (h("div", { class: `
          ...
          ${this.active ? ACTIVE_CLASS : ''}
          ${this._fluidClass}
          ${this.description ? LIST_CLASS : ''}`, ref: (ref) => (this._dropdownMenuElement = ref) }, this.renderDropdownMenuHeader(isMultiItems), this.renderDropdownMenuItems(isMultiItems), this.renderDropdownMenuFooter(isMultiItems)));
    }
    ...
    renderSelectMultiHeaderContent() {
        ...
        return (h("div", { class: UTILITY_CLASSES.PADDING.X[1] }, h("div", { class: UTILITY_CLASSES.PADDING.LEFT[1] }, h("chi-checkbox", { label: "Select all", checked: checked, indeterminate: indeterminate, onChiChange: () => this._onMultiSelectAllChanged() })), h("div", { class: DIVIDER_CLASSES.DIVIDER })));
    }
