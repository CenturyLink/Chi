...
const SearchInput = class {
    ...
    render() {
        ...
        const searchIcon = (h("button", { key: 'd1490840e1fdc172be44607109a7a6c8f0c88134', class: `
        chi-button -icon -flat -bg--none
        ${this.size ? `-${this.size}` : ''}
        `, onClick: () => this.eventSearch.emit(this.value), "aria-label": "Search" }, h("div", { key: '4bf78fe2c22931c2c9f58da4aef9594d395a8554', class: "chi-button__content" }, h("i", { key: 'e1416aba19734f29540d0b97efd34b51c25dc309', class: 'chi-icon icon-search', "aria-hidden": "true" }))));
        const input = (h("div", { key: '33b830ca7ca2208b800756902a9422a7f1894d2b', class: "chi-input__wrapper -icon--right", slot: "trigger" }, searchInputElement, searchXIcon, searchIcon));
