import { r as registerInstance, c as createEvent, h, F as Fragment, g as getElement } from './index-cde0ed0d.js';
import { c as TEXT_INPUT_SIZES } from './size-9d0c9884.js';
import { C as CHI_STATES } from './states-a5be3f93.js';
import { n as DROPDOWN_CLASSES } from './classes-fca9c660.js';
import { b as cleanUndefinedProps } from './utils-416d6cef.js';
import { v as v4 } from './v4-4e9fbb64.js';
import { I as ICON_COLORS } from './color-b6e4748b.js';
import { h as TEXT_INPUT_TYPES, c as CLASSES } from './constants-76e3b213.js';
...
const SearchInput = class {
    ...
    render() {
        ...
        const searchIcon = (h("button", { key: 'fdfca1aadefa4ebbe46395e435d45fc63657b7b4', class: `
        chi-button -icon -flat -bg--none
        ${this.size ? `-${this.size}` : ''}
        `, onClick: () => this.eventSearch.emit(this.value), "aria-label": "Search" }, h("div", { key: '2aa85a7c02558675df534dda150891162ad77e3a', class: "chi-button__content" }, h("i", { key: '06e222e78de86b74bd6035996b8a9f49c2f74e35', class: 'chi-icon icon-search', "aria-hidden": "true" }))));
        const input = (h("div", { key: '6c1875682bd7db4bfdc0dec3ee5e6fb689553188', class: "chi-input__wrapper -icon--right", slot: "trigger" }, searchInputElement, searchXIcon, searchIcon));
