...
const searchInputScss = "chi-search-input.sc-chi-search-input-h{display:block;width:100%}";
const ChiSearchInputStyle0 = searchInputScss;
...
const textInputScss = "chi-text-input.sc-chi-text-input-h{display:block;width:100%}";
const ChiTextInputStyle0 = textInputScss;
