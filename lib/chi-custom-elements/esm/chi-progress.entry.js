...
const Progress = class {
    ...
    render() {
        return (h("progress", { key: 'a0044eaf67a11fbcf0982bafe361c570d80d5a35', "aria-valuenow": this.value || undefined, "aria-valuemax": this.max || undefined, "aria-valuemin": 0, class: this.state ? `-${this.state}` : '', max: this.max || undefined, role: "progressbar", value: this.value }));
    }
