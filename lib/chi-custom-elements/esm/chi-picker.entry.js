...
import { t as PICKER_CLASSES, u as PILL_CLASS, G as GENERIC_SIZE_CLASSES, U as UTILITY_CLASSES, F as FORM_CLASSES, R as ROW_CLASS, m as INPUT_CLASSES } from './classes-d4369523.js';
...
const Picker = class {
    ...
    render() {
        ...
        if (this.helperMessage) {
            fieldSet = (h("div", { key: 'c0a1abadb09544bb3fefa463fc20879d28b087a3', class: INPUT_CLASSES.WRAPPER }, fieldSet, h("chi-helper-message", { key: '543570be86232c0947294fd7d4f45c0860a00a77', state: this.state }, this.helperMessage)));
        }
        return fieldSet;
    }
