...
import { p as PICKER_CLASSES, q as PILL_CLASS, G as GENERIC_SIZE_CLASSES, U as UTILITY_CLASSES, F as FORM_CLASSES, R as ROW_CLASS, h as INPUT_CLASSES } from './classes-f1a396c8.js';
...
const Picker = class {
    ...
    render() {
        ...
        if (this.helperMessage) {
            fieldSet = (h("div", { key: '5181a06a5141203a01864c01c8c16230738496d2', class: INPUT_CLASSES.WRAPPER }, fieldSet, h("chi-helper-message", { key: '95940ed910e64567d17f6732f1e3b98ad197214c', state: this.state }, this.helperMessage)));
        }
        return fieldSet;
    }
