...
const numberInputScss = "chi-number-input.sc-chi-number-input-h{display:-ms-inline-flexbox !important;display:inline-flex !important;position:relative;vertical-align:middle}";
const ChiNumberInputStyle0 = numberInputScss;
...
const NumberInput = class {
    ...
    render() {
        ...
        if (this.helperMessage) {
            input = (h("div", { key: 'b5fb9240ff3697dec4899af1b0d45cbf3fba4878', class: "chi-input__wrapper" }, input, this.getHelperMessage()));
        }
        return input;
    }
