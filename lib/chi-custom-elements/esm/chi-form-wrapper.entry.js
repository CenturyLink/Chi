...
import { F as FORM_CLASSES, U as UTILITY_CLASSES, i as FORM_WRAPPER_CLASSES, j as INPUT_CLASSES } from './classes-26189a5f.js';
...
const FormWrapper = class {
    ...
    render() {
        ...
        if (this.helperMessage) {
            fieldSet = (h("div", { key: '67dc9427e209f9e1048ba72dc1d258a42ab6cf00', class: INPUT_CLASSES.WRAPPER }, fieldSet, h("chi-helper-message", { key: 'dc2481837ff546b6edbed47abefdd4a320310fd8', state: this.state }, this.helperMessage)));
        }
        return fieldSet;
    }
