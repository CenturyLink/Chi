...
import { F as FORM_WRAPPER_LAYOUTS, e as FORM_WRAPPER_TYPES } from './constants-e61c7d0c.js';
import { F as FORM_CLASSES, U as UTILITY_CLASSES, l as FORM_WRAPPER_CLASSES, m as INPUT_CLASSES } from './classes-d4369523.js';
...
const FormWrapper = class {
    ...
    render() {
        ...
        if (this.helperMessage) {
            fieldSet = (h("div", { key: '9d25a809a1ff5f961d65d17176381073a33e307e', class: INPUT_CLASSES.WRAPPER }, fieldSet, h("chi-helper-message", { key: '513b7d099c074d42155a8d302c7713258dd10135', state: this.state }, this.helperMessage)));
        }
        return fieldSet;
    }
