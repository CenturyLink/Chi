...
import { f as APP_LAYOUT_FORMATS } from './constants-e61c7d0c.js';
...
const AppLayout = class {
    ...
    render() {
        ...
        const appLayoutPageLevelActions = this.appLayoutPageLevelActions && (h("div", { key: '8e08e45e83db11af7ec74d12bbb02e119998c079', class: "-d--flex -align-items--center -justify-content--end -py--3 -mt--2 -bt--1" }, h("slot", { key: 'cc55aff357432768fc170d1a170f6581b5eed020', name: "page-level__actions" })));
