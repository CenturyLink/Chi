...
export const CENTER_CLASS = '-center';
export const CENTERED_CLASS = '-centered';
...
export const NO_BORDER_CLASS = '-no-border';
export const ONE_LINK_TX = 'OneLinkTx';
export const PILL_CLASS = '-pill';
...
export const TRUNCATED_CLASS = '-truncated';
//#endregion
//#region Accordion
