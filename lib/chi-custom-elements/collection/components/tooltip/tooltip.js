...
export class Tooltip {
    ...
    render() {
        return (h("div", { key: '9da8de24e3d1c3c92be3851167619998eb104368', class: this.wrapper ? TOOLTIP_CLASSES.TOOLTIP_WRAPPER : '', ref: (el) => (this._tooltipRef = el), "aria-describedby": this.tooltipVisible ? this._id : null }, h("slot", { key: '4bdf84e956f2067140d850ebc1315abf64342b29' }), h("div", { key: 'd4a9d221e9c4941d0af7357c31cf135fa3284f50', class: {
                [TOOLTIP_CLASSES.TOOLTIP_ELEMENT]: true,
                [LIGHT_CLASS]: this.color === 'light',
            }, id: this._id, role: "tooltip", ref: (el) => (this._tooltipElementNode = el), "aria-hidden": !this.tooltipVisible }, h("span", { key: '61faa322ddffc7fc15606ebb9b6a91d7358d573b' }, this.message))));
    }
