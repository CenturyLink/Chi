...
export class Tooltip {
    ...
    render() {
        return (h("div", { key: '2dfb5cf52dfb88eeac810005eb15f311705c4307', class: this.wrapper ? TOOLTIP_CLASSES.WRAPPER : '', ref: (el) => (this._tooltipRef = el), "aria-describedby": this.tooltipVisible ? this._id : null }, h("slot", { key: 'e2c049d916d8a798756982590040b429eb236280' }), h("div", { key: 'b3caca665c79b6c7a70079bfc6b78482d083a1e8', class: {
                [TOOLTIP_CLASSES.ELEMENT]: true,
                [LIGHT_CLASS]: this.color === 'light',
            }, id: this._id, role: "tooltip", ref: (el) => (this._tooltipElementNode = el), "aria-hidden": !this.tooltipVisible }, h("span", { key: 'f1425294464771bad4f3c74692bfbebd9e337dd5', class: TOOLTIP_CLASSES.MESSAGE }, this.message))));
    }
