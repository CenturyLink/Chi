...
export class Tooltip {
    ...
    render() {
        return (h("div", { key: '0b5dfa71e82dacbf6acec7c899a427fc0940065e', class: this.wrapper ? TOOLTIP_CLASSES.TOOLTIP_WRAPPER : '', ref: (el) => (this._tooltipRef = el), "aria-describedby": this.tooltipVisible ? this._id : null }, h("slot", { key: 'ff315dfb88b8299058a9c7fe8bd9d380bc6048b4' }), h("div", { key: '7125fd430a58bfd53e54ccca3d45cd9e62d3715c', class: {
                [TOOLTIP_CLASSES.TOOLTIP_ELEMENT]: true,
                [LIGHT_CLASS]: this.color === 'light',
            }, id: this._id, role: "tooltip", ref: (el) => (this._tooltipElementNode = el), "aria-hidden": !this.tooltipVisible }, h("span", { key: '3cd36e34555428c4a38ea5f40f41b1e7373e5553' }, this.message))));
    }
