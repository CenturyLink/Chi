...
export class Tooltip {
    ...
    render() {
        return (h("div", { key: '1fb2f21de0088d21f572701a4aee2e49c4102812', class: this.wrapper ? TOOLTIP_CLASSES.WRAPPER : '', ref: (el) => (this._tooltipRef = el), "aria-describedby": this.tooltipVisible ? this._id : null }, h("slot", { key: '96072e3e59a7334c5ae2ea955e33d2375e539490' }), h("div", { key: '2266399194e4b8dbddd116856c5d02c84ab98817', class: {
                [TOOLTIP_CLASSES.ELEMENT]: true,
                [LIGHT_CLASS]: this.color === 'light',
            }, id: this._id, role: "tooltip", ref: (el) => (this._tooltipElementNode = el), "aria-hidden": !this.tooltipVisible }, h("span", { key: 'd736e17cd9f2340a153fc84c30f3d5efe1390c32', class: TOOLTIP_CLASSES.MESSAGE }, this.message))));
    }
