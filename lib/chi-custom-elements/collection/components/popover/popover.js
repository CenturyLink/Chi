...
export class Popover {
    ...
    render() {
        ...
        const popoverHeader = this.popoverTitle && (h("header", { key: '74ac9ab3f3c8ea9ad978fafc840d00f5b642c381', ref: (el) => (this._popoverHeader = el), class: POPOVER_CLASSES.HEADER }, h("h2", { key: '989dafac2ec23fcb6bb1c29cf8b8911a98ca5ca4', class: POPOVER_CLASSES.TITLE }, this.popoverTitle)));
        const slot = this.variant && this.variant === 'text' ? (h("p", { class: POPOVER_CLASSES.TEXT }, h("slot", null))) : (h("slot", null));
        const chiFooter = this.popoverFooter && (h("div", { key: '834afca74b6eec92bd27320d3217bda37a1cb25a', class: POPOVER_CLASSES.FOOTER }, h("slot", { key: '5b1bb3eebb7df62479fbaf895ccfbac21e118d48', name: POPOVER_CLASSES.FOOTER })));
        return (h("section", { key: '6ddb28b1f9feda435f9f63d0c61ab818a1aae764', class: `
        ...
        `, ref: (el) => (this._popoverElement = el), onClick: () => this.preventAutoClose(), role: "dialog", "aria-modal": "true", "aria-label": this.popoverTitle, "aria-hidden": !this.active }, closeButton, popoverHeader, h("div", { key: '7d480ce43c082d587a28b3dab7c5bbbb3660df83', class: POPOVER_CLASSES.CONTENT }, slot), chiFooter, this.arrow && h("div", { key: '6d4f26862ab7d29ba92714d3adf1e5d5b62a6bae', class: POPOVER_CLASSES.ARROW })));
    }
