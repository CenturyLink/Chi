...
export class Popover {
    ...
    render() {
        ...
        const popoverHeader = this.popoverTitle && (h("header", { key: '9291ec175ebdc270c0787318f21cfc7a50d119a9', ref: (el) => (this._popoverHeader = el), class: POPOVER_CLASSES.HEADER }, h("h2", { key: 'e2a9383cc8108c597e99c40b0b5843964827ceef', class: POPOVER_CLASSES.TITLE }, this.popoverTitle)));
        const slot = this.variant && this.variant === 'text' ? (h("p", { class: POPOVER_CLASSES.TEXT }, h("slot", null))) : (h("slot", null));
        const chiFooter = this.popoverFooter && (h("div", { key: 'e9267154a259e547175e6f9014080456db2f917a', class: POPOVER_CLASSES.FOOTER }, h("slot", { key: '897a72b2b8175be007c54af44f23f2f39213d3d3', name: POPOVER_CLASSES.FOOTER })));
        return (h("section", { key: '137bed1a82ea6aafbfda0b3d00f423cd99fbf280', class: `
        ...
        `, ref: (el) => (this._popoverElement = el), onClick: () => this.preventAutoClose(), role: "dialog", "aria-modal": "true", "aria-label": this.popoverTitle, "aria-hidden": !this.active }, closeButton, popoverHeader, h("div", { key: '1c2e9ccb7b89e1a7727962f2f7e95b682d119a3a', class: POPOVER_CLASSES.CONTENT }, slot), chiFooter, this.arrow && h("div", { key: '8615cd2dae8c0910e36298642940130c63155596', class: POPOVER_CLASSES.ARROW })));
    }
