...
export class Popover {
    ...
    _postAnimationTransformStyle;
    _componentLoaded = false;
    _didUpdateCallBackOnceQueue = [];
    _closePrevented = false;
    _closePreventedTimeout;
    ...
    render() {
        ...
        const popoverHeader = this.popoverTitle && (h("header", { key: 'fc813bc4d5aeaa6096f772ac8125ce86f35a339c', ref: (el) => (this._popoverHeader = el), class: POPOVER_CLASSES.HEADER }, h("h2", { key: '2ce531ec6ba4043d7fc1513f9e7e1ac71ae08b5d', class: POPOVER_CLASSES.TITLE }, this.popoverTitle)));
        const slot = this.variant && this.variant === 'text' ? (h("p", { class: POPOVER_CLASSES.TEXT }, h("slot", null))) : (h("slot", null));
        const chiFooter = this.popoverFooter && (h("div", { key: '9b5bba7e501d0f690f77370f3a52ec1d618e9472', class: POPOVER_CLASSES.FOOTER }, h("slot", { key: 'c916ee260cbd2bfb8bb47804ae574b815b582aa5', name: POPOVER_CLASSES.FOOTER })));
        return (h("section", { key: '28cd20e07c9eea05c9946131d398c0678d5a1d62', class: `
        ...
        `, ref: (el) => (this._popoverElement = el), onClick: () => this.preventAutoClose(), role: "dialog", "aria-modal": "true", "aria-label": this.popoverTitle, "aria-hidden": !this.active }, closeButton, popoverHeader, h("div", { key: '4babec964ef376b519c48499630f413ad40c0945', class: POPOVER_CLASSES.CONTENT }, slot), chiFooter, this.arrow && h("div", { key: 'f6617e7204fed1d655e10ecbf683ad85b3622dae', class: POPOVER_CLASSES.ARROW })));
    }
