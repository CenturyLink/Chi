...
export class Progress {
    ...
    render() {
        return (h("progress", { key: '80e799d84b6a5d3fcef54a8ce36d473eecd72c04', "aria-valuenow": this.value || undefined, "aria-valuemax": this.max || undefined, "aria-valuemin": 0, class: this.state ? `-${this.state}` : '', max: this.max || undefined, role: "progressbar", value: this.value }));
    }
