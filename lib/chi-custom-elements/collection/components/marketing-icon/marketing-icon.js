...
export class MarketingIcon {
    ...
    render() {
        return (h("div", { key: '1b21b5a6b10d86ab908fe47c545fcb8aae37aa90', class: `chi-marketing-icon ${this.variant} ${this.getClass()} ${this.extraClass ? this.extraClass : ''}` }, h("svg", { key: '4525831715674315bf997e84117ee386bc1fb886', xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true" }, h("use", { key: '8aa97cae9add5494617fd923829935d9c3f3a9b4', xlinkHref: `#icon-${this.variant}-${this.icon}` }))));
    }
