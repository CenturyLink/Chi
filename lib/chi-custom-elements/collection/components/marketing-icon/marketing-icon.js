...
export class MarketingIcon {
    ...
    render() {
        return (h("div", { key: 'f5069b87c8f4cd298b58274b7a576bdd87da1df1', class: `chi-marketing-icon ${this.variant} ${this.getClass()} ${this.extraClass ? this.extraClass : ''}` }, h("svg", { key: '307e0d99208e12c26ace3154b5b90ec2ea22189c', xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true" }, h("use", { key: '59e2f288a984710d945bd598a92fb3ed87672999', xlinkHref: `#icon-${this.variant}-${this.icon}` }))));
    }
