...
export class MarketingIcon {
    ...
    render() {
        return (h("div", { key: '82e6bfa94cc03fb2b70c1ae3e4ecc115409f8e87', class: `chi-marketing-icon ${this.variant} ${this.getClass()} ${this.extraClass ? this.extraClass : ''}` }, h("svg", { key: '4c4c11e11821715311d62351ac0346ba81ddff2c', xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true" }, h("use", { key: '234b26be6853c4a3c5a6edc8e4d3a00fbfef87ff', xlinkHref: `#icon-${this.variant}-${this.icon}` }))));
    }
