...
export class CopyText {
    ...
    render() {
        return (h("chi-button", { key: '32da684a6d81c141719c68597aa267a19ca56f51', type: "icon", variant: "flat", disabled: this.disabled, "data-tooltip": COPY_MESSAGE, onChiClick: () => this.handlerClick(), onChiMouseLeave: () => this.setTooltipMsg(COPY_MESSAGE) }, h("chi-icon", { key: 'df3fe6bc129d70ea914c6cae23447933c03d49e0', icon: "copy", size: this.size })));
    }
