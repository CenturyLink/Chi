...
export class CopyText {
    ...
    render() {
        return (h("chi-tooltip", { key: '9568f4b2f9df0ed7281a09c6ff80e75fac51f774', wrapper: true, message: this.tooltipMessage }, h("chi-button", { key: 'a41571619ba802b73c5c479926e179da1ac0f5e5', type: "icon", variant: "flat", disabled: this.disabled, onChiClick: () => this.handlerClick(), onChiMouseLeave: () => this.setTooltipMsg(COPY_MESSAGE) }, h("chi-icon", { key: 'b601e1c5951e6ae3d33980f3964194a4a4912031', icon: "copy", size: this.size }))));
    }
