...
export class TimePicker {
    ...
    render() {
        const chiPopover = (h("chi-popover", { key: '77a294f9d7abab2ec546e0260c9e34ac1e2b9374', id: `popover-${this._uuid}`, position: "bottom", reference: `#${this._uuid}-control`, "prevent-auto-hide": true, active: this.active }, h("chi-time", { key: '023a31f9c2fc8d9a88ba0aa959ec12675ca82602', "display-seconds": this.displaySeconds, "excluded-hours": this._excludedHours, "excluded-minutes": this._excludedMinutes, "excluded-seconds": this._excludedSeconds, format: this.format, value: this.value, "seconds-step": this.secondsStep, "minutes-step": this.minutesStep })));
        return (h("div", { key: '3e76ab8d9547c2c1a96515e4798004a3b2472c56', class: this.disabled ? '-disabled' : '' }, h("div", { key: '612c70e60ab71fa71671b3c1edc2167e9e0942d1', class: "chi-input__wrapper -icon--right" }, h("input", { key: 'c77800ad5a99ca004cfe5e9fd966f1d54d279673', id: `${this._uuid}-control`, class: `chi-input
              ${this.active ? '-focus' : ''}`, type: `text`, placeholder: this.format === '12hr' ? '--:-- --' : '--:--', ref: (el) => (this._input = el), value: this.value, disabled: this.disabled }), h("chi-icon", { key: '9d634969e29fddc3cecc9a19031e6689a62eb343', icon: "circle-clock-outline" })), !this.disabled && chiPopover));
    }
