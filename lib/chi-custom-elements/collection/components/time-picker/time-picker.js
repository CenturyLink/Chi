...
export class TimePicker {
    ...
    render() {
        const chiPopover = (h("chi-popover", { key: 'dccb10714bba03d92d3a4ddbd4674fd2cb4d62ae', id: `popover-${this._uuid}`, position: "bottom", reference: `#${this._uuid}-control`, "prevent-auto-hide": true, active: this.active }, h("chi-time", { key: 'a71c68d03855c25dd3a978035b756bc811e6cd2a', "display-seconds": this.displaySeconds, "excluded-hours": this._excludedHours, "excluded-minutes": this._excludedMinutes, "excluded-seconds": this._excludedSeconds, format: this.format, value: this.value, "seconds-step": this.secondsStep, "minutes-step": this.minutesStep })));
        return (h("div", { key: 'fca2ac773d8f35f5596ce94b4a7a58d95c12d544', class: this.disabled ? '-disabled' : '' }, h("div", { key: 'fbe49917f6f1080f7aee27c7bb0713cc086f9c16', class: "chi-input__wrapper -icon--right" }, h("input", { key: '4047d40a9e89090e956cfcfef9bd6595511ceeaa', id: `${this._uuid}-control`, class: `chi-input
              ${this.active ? '-focus' : ''}`, type: `text`, placeholder: this.format === '12hr' ? '--:-- --' : '--:--', ref: (el) => (this._input = el), value: this.value, disabled: this.disabled }), h("chi-icon", { key: '96b6fb2564a94b1c8f78df58fabe3c4a00cbb302', icon: "circle-clock-outline" })), !this.disabled && chiPopover));
    }
