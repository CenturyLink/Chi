...
export class Date {
    ...
    render() {
        ...
        return (h("div", { key: '6f76ca34cbac087895288ef1f61bdfd1f438721e', class: `${DATEPICKER_CLASSES.DATEPICKER} ${this._vm.weekStartClass} ${this._vm.monthStartClass}` }, h("div", { key: '374dd57eea05cff65fe30b0a3903d047649437b1', class: `${DATEPICKER_CLASSES.MONTH_ROW}` }, h("div", { key: '83c030864f5e4fa2fa8c2376cfe310a9e11dcea3', class: `${DATEPICKER_CLASSES.PREV_MONTH} ${prevMonthDisabled ? CLASSES.DISABLED : ''}`, tabindex: "0", onClick: () => this.prevMonth() }, h("chi-icon", { key: 'dca591347fd4ea7b0b2969c0994742bd1c950820', icon: "chevron-left", size: "sm" })), h("div", { key: '372b65c5aaede1cb8614b34096b5bf2777ae3a54', class: `${DATEPICKER_CLASSES.MONTH}` }, `${this.viewMonth.format('MMMM')}
              ${this.viewMonth.format('YYYY')}`), h("div", { key: 'e166501dc88411f1c69e0006d7e6efca44dac1cb', class: `${DATEPICKER_CLASSES.NEXT_MONTH} ${nextMonthDisabled ? CLASSES.DISABLED : ''}`, tabindex: !nextMonthDisabled ? '0' : '', onClick: () => this.nextMonth() }, h("chi-icon", { key: 'acd437be6e8322363fb9c79a1f42349cc4b85e40', icon: "chevron-right", size: "sm" }))), h("div", { key: 'a477c6abe20ff7be0569462ff49056c61987ee72', class: `${DATEPICKER_CLASSES.DAY_NAMES}` }, this._vm.weekDays.map((weekDay) => (h("div", { class: `${DATEPICKER_CLASSES.WEEK_DAY}`, key: weekDay.format('dddd') }, weekDay.format('dddd').substr(0, 1))))), h("div", { key: 'bb1131c228ed5deb01bba94ebe84ab4664685cf7', class: `${DATEPICKER_CLASSES.DAYS}` }, this._vm.monthDays.map((day) => {
