...
export class SearchInput {
    ...
    render() {
        const isAutocomplete = this._isAutocomplete();
        const searchInputElement = (h("input", { key: 'c69ec88abe5651c099df34370a40daffcd0403d5', type: "search", class: `
        ...
        const searchIcon = (h("button", { key: '54f1b07673a40679ad4faf10f8571e58529f0b1e', class: `
        chi-button -icon -flat -bg--none
        ${this.size ? `-${this.size}` : ''}
        `, onClick: () => this.eventSearch.emit(this.value), "aria-label": "Search" }, h("div", { key: '2bee92dbc41cdce3f39cb9257f69abe0b59e569b', class: "chi-button__content" }, h("i", { key: '2cfc7efbbc2254275d1e9f333713d46d0cf5dc79', class: 'chi-icon icon-search', "aria-hidden": "true" }))));
        const input = (h("div", { key: '34070a5f575e34ed3b844f39f4ed1e6cf9f49196', class: "chi-input__wrapper -icon--right", slot: "trigger" }, searchInputElement, searchXIcon, searchIcon));
