...
export class SearchInput {
    ...
    render() {
        const isAutocomplete = this._isAutocomplete();
        const searchInputElement = (h("input", { key: 'c2abf734d615c8a1a976afa0a2e9a077e087c1ca', type: "search", class: `
        ...
        const searchIcon = (h("button", { key: 'c3c584723bdced204f8b27c0e66f51c098267ba5', class: `
        chi-button -icon -flat -bg--none
        ${this.size ? `-${this.size}` : ''}
        `, onClick: () => this.eventSearch.emit(this.value), "aria-label": "Search" }, h("div", { key: '02eceeb99d751379b3aed861e33ab7a782e8f9ef', class: "chi-button__content" }, h("i", { key: '7cfbea808509308d835042c8c5db25cbf4c75e2a', class: 'chi-icon icon-search', "aria-hidden": "true" }))));
        const input = (h("div", { key: '0ba741103f1c99d107d204d0f0d65b5db989e1b0', class: "chi-input__wrapper -icon--right", slot: "trigger" }, searchInputElement, searchXIcon, searchIcon));
