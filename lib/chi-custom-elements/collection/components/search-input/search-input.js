...
export class SearchInput {
    ...
    render() {
        const isAutocomplete = this._isAutocomplete();
        const searchInputElement = (h("input", { key: '7805009cf5c839d54f22f28bc10034c592b462ee', type: "search", class: `
        ...
        const searchIcon = (h("button", { key: 'ee9c2fdb7e8db96a716fec3e7394164c8953d600', class: `
        chi-button -icon -flat -bg--none
        ${this.size ? `-${this.size}` : ''}
        `, onClick: () => this.eventSearch.emit(this.value), "aria-label": "Search" }, h("div", { key: '56dcefd7386893fd4fe5c336b1aa5dfd17e86f92', class: "chi-button__content" }, h("i", { key: '699c91ee3c1942f73a669b9d68a9382ad2555491', class: 'chi-icon icon-search', "aria-hidden": "true" }))));
        const input = (h("div", { key: '00726ccf269a25eb0b72e26273ab3e07a9f8e4e2', class: "chi-input__wrapper -icon--right", slot: "trigger" }, searchInputElement, searchXIcon, searchIcon));
