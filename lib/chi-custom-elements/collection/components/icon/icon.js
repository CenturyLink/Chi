...
export class Icon {
    ...
    render() {
        ...
        return (h("div", { key: 'e20be8b5e9bee178010254a70c48f80d66a6934a', class: `chi-icon ${this.getClass()} ${extraClass}` }, h("svg", { key: '9ed3c90bebb3ae1bccec9dad0b85d8925f27dae0', xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true" }, h("use", { key: '742e2bae55b06ca34e8f75e4316ebd9389d2059a', xlinkHref: '#icon-' + this.icon }))));
    }
