...
import countryList from "all-country-data/dist/countryList";
...
export class ChiPhoneInput {
    ...
    _getCorrectCountryList() {
        return [...countryList(), ...EXTRA_COUNTRIES].sort((a, b) => a.country.localeCompare(b.country));
    }
    ...
    render() {
        ...
        const textInput = (h("chi-text-input", { key: '557e0dd7b8bb37e49d5e7b79a573676211c1f08a', id: `${this._uuid}`, type: "tel", state: this.state ? this.state : null, size: this.size, helperMessage: this.helperMessage, disabled: this.disabled, placeholder: this.placeholder, value: this._suffix, onChiChange: this._suffixInputChangeHandler, onChiInput: this._inputHandler, onKeyPress: this._keyPressHandler, onPaste: this._pasteHandler }));
        return (h("div", { key: '6a4a2105390d79f9128ff06d208230b1c8ad2fcb', class: `${PHONE_INPUT_CLASSES.PHONE_INPUT}` }, dropdown, textInput));
    }
    ...
    static get events() {
        return [{
                ...
                "method": "chiCountrySelected",
                "name": "chiCountrySelected",
                "bubbles": true,
                "cancelable": true,
                "composed": true,
                "docs": {
                    "tags": [],
                    "text": "Triggered when the user selected a country in the dropdown"
                },
                "complexType": {
                    "original": "Country",
                    "resolved": "Country",
                    "references": {
                        "Country": {
                            ...
                            "id": "src/constants/types.ts::Country"
                        }
                    }
                }
            }];
