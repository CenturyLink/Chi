...
export class ChiPhoneInput {
    ...
    chiNumberInvalid;
    el;
    _extraCountryCodes = EXTRA_COUNTRIES.map((item) => item.country_code);
    excludedCountriesArray;
    componentWillLoad() {
    ...
    _suffixInputChangeHandler = (event) => {
    ...
    render() {
        ...
        const textInput = (h("chi-text-input", { key: '8e32b94f1116fc2e069b44523d7338b7b682788c', id: `${this._uuid}`, type: "tel", state: this.state ? this.state : null, size: this.size, helperMessage: this.helperMessage, disabled: this.disabled, placeholder: this.placeholder, value: this._suffix, onChiChange: this._suffixInputChangeHandler, onChiInput: this._inputHandler, onKeyPress: this._keyPressHandler, onPaste: this._pasteHandler }));
        return (h("div", { key: 'c9c94df151f699a71422bb403a3e19a2483fb2c4', class: `${PHONE_INPUT_CLASSES.PHONE_INPUT}` }, dropdown, textInput));
    }
