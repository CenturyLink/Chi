...
export class ChiPhoneInput {
    ...
    render() {
        ...
        const textInput = (h("chi-text-input", { key: '2e675300eaa081bfc1b8448b7b4c6ef628a6153e', id: `${this._uuid}`, type: "tel", state: this.state ? this.state : null, size: this.size, helperMessage: this.helperMessage, disabled: this.disabled, placeholder: this.placeholder, value: this._suffix, onChiChange: this._suffixInputChangeHandler, onChiInput: this._inputHandler, onKeyPress: this._keyPressHandler, onPaste: this._pasteHandler }));
        return (h("div", { key: '4f74d8e994b13b4ca742eca12ed0da177e863d81', class: `${PHONE_INPUT_CLASSES.PHONE_INPUT}` }, dropdown, textInput));
    }
