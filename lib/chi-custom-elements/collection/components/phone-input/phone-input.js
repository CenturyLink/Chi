...
export class ChiPhoneInput {
    ...
    render() {
        ...
        const textInput = (h("chi-text-input", { key: '05b9ef3b87005e55e4fa77121ca98aaaceeb2ea1', id: `${this._uuid}`, type: "tel", state: this.state ? this.state : null, size: this.size, helperMessage: this.helperMessage, disabled: this.disabled, placeholder: this.placeholder, value: this._suffix, onChiChange: this._suffixInputChangeHandler, onChiInput: this._inputHandler, onKeyPress: this._keyPressHandler, onPaste: this._pasteHandler }));
        return (h("div", { key: '333209128d72fca838a0d3498eb9b33021b8e692', class: `${PHONE_INPUT_CLASSES.PHONE_INPUT}` }, dropdown, textInput));
    }
