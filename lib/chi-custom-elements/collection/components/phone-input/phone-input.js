...
export class ChiPhoneInput {
    ...
    render() {
        ...
        const textInput = (h("chi-text-input", { key: '073544562dd0aabcd6b71c145bcc57223a889617', id: `${this._uuid}`, type: "tel", state: this.state ? this.state : null, size: this.size, helperMessage: this.helperMessage, disabled: this.disabled, placeholder: this.placeholder, value: this._suffix, onChiChange: this._suffixInputChangeHandler, onChiInput: this._inputHandler, onKeyPress: this._keyPressHandler, onPaste: this._pasteHandler }));
        return (h("div", { key: '451e10c3709c7e876db9b412d7f205ba212290ee', class: `${PHONE_INPUT_CLASSES.PHONE_INPUT}` }, dropdown, textInput));
    }
