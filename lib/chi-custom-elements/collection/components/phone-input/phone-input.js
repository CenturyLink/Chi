...
export class ChiPhoneInput {
    ...
    render() {
        ...
        const textInput = (h("chi-text-input", { key: 'f2d2336672b12c2146c5e276c7e2749accdf0485', id: `${this._uuid}`, type: "tel", state: this.state ? this.state : null, size: this.size, helperMessage: this.helperMessage, disabled: this.disabled, placeholder: this.placeholder, value: this._suffix, onChiChange: this._suffixInputChangeHandler, onChiInput: this._inputHandler, onKeyPress: this._keyPressHandler, onPaste: this._pasteHandler }));
        return (h("div", { key: 'a7f0d8de78fee646019c70173f489eb2e99ca8e7', class: `${PHONE_INPUT_CLASSES.PHONE_INPUT}` }, dropdown, textInput));
    }
