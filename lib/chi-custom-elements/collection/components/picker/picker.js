...
export class Picker {
    ...
    render() {
        ...
        if (this.helperMessage) {
            fieldSet = (h("div", { key: '277431291e49842776bb72befdabf6a93bd52bd5', class: INPUT_CLASSES.WRAPPER }, fieldSet, h("chi-helper-message", { key: '216893fd4e0e054fe6cd6e68f4266b0bd1655771', state: this.state }, this.helperMessage)));
        }
        return fieldSet;
    }
