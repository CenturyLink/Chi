...
export class FormWrapper {
    ...
    render() {
        ...
        if (this.helperMessage) {
            fieldSet = (h("div", { key: '8d7cf4ca30e25496fc3ed3974377e9bf574d1901', class: INPUT_CLASSES.WRAPPER }, fieldSet, h("chi-helper-message", { key: 'afa4a11b82c7957cbbce90c01ceecb93d693d0dc', state: this.state }, this.helperMessage)));
        }
        return fieldSet;
    }
