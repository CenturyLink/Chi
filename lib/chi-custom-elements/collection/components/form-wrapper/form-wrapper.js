...
export class FormWrapper {
    ...
    componentWillLoad() {
        var _a;
        this.options = ((_a = this.options) !== null && _a !== void 0 ? _a : []).map((item) => (Object.assign(Object.assign({}, item), { id: item.id || `${this.id}-${uuid4()}`, checked: item.checked || false })));
    }
    _getLabel() {
        if (this.label) {
