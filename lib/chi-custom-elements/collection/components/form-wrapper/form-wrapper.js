...
export class FormWrapper {
    ...
    render() {
        ...
        if (this.helperMessage) {
            fieldSet = (h("div", { key: '13a7cba2690f6ec5a3a7b1931c2f3974066c3496', class: INPUT_CLASSES.WRAPPER }, fieldSet, h("chi-helper-message", { key: '54ef5be4382d4d5d207fa6b1629532972b921e7f', state: this.state }, this.helperMessage)));
        }
        return fieldSet;
    }
