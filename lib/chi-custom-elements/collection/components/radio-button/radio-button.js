...
export class RadioButton {
    ...
    render() {
        ...
        return (h("div", { key: '8437c715e7b7a40af85790403c670a852b10a260', class: RADIO_CLASSES.RADIO }, h("input", { key: '5e0c6c858df0f551d27eb1c320b722f679d803de', class: `
            ${RADIO_CLASSES.INPUT}
            ${stateClass}
          `, id: this.id, checked: this.checked, disabled: this.disabled, name: this.name, "aria-checked": this.checked, "aria-labelledby": this.labelId, onBlur: () => this.blur(), onChange: (ev) => this.change(ev), onFocus: () => this.focus(), type: "radio" }), h("label", { key: '6f6899b6545613660606670e5f80886116f728c4', id: this.labelId, class: RADIO_CLASSES.LABEL, htmlFor: this.id }, this.label)));
    }
