...
export class RadioButton {
    ...
    render() {
        ...
        return (h("div", { key: '87435aa4da83c672b69c615ca17872cd3a4e389d', class: RADIO_CLASSES.RADIO }, h("input", { key: 'e83a8d84bd4cc80855d1cf8749c9448ec3541f75', class: `
            ${RADIO_CLASSES.INPUT}
            ${stateClass}
          `, id: this.id, checked: this.checked, disabled: this.disabled, name: this.name, "aria-checked": this.checked, "aria-labelledby": this.labelId, onBlur: () => this.blur(), onChange: (ev) => this.change(ev), onFocus: () => this.focus(), type: "radio" }), h("label", { key: '56953d8ce9e964bddcbca0cec0a8a294e84aee16', id: this.labelId, class: RADIO_CLASSES.LABEL, htmlFor: this.id }, this.label)));
    }
