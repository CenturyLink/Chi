...
export class Accordion {
    ...
    render() {
        var _a;
        return (h("div", { key: 'b7d20fd39edb7ca0a9670901d558f46321d64000', class: this.getAccordionClasses() }, ...(_a = this.accordions) === null || _a === void 0 ? void 0 : _a.map((accordion, index) => this.getAccordionItem(accordion, index))));
    }
