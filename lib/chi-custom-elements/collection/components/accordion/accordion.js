...
import { ACCORDION_CLASSES, CARD_CLASS, DISABLED_CLASS, EXPANDED_CLASS, ICON_CLASS, TRUNCATED_CLASS, UTILITY_CLASSES, } from "../../constants/classes";
...
export class Accordion {
    ...
    getLinkTrigger(accordion, index) {
        ...
        if (!iconLeft)
            content.reverse();
        return (h("div", { class: triggerClasses, onClick: () => this.toggleAccordion(index) }, h("chi-link", null, content)));
    }
    ...
    render() {
        var _a;
        return (h("div", { key: 'deb7dd6ff981f7e39f668755bedca92724424294', class: this.getAccordionClasses() }, ...(_a = this.accordions) === null || _a === void 0 ? void 0 : _a.map((accordion, index) => this.getAccordionItem(accordion, index))));
    }
