...
export class Accordion {
    ...
    render() {
        var _a;
        return (h("div", { key: 'd161e215e551dff7350683d047db24c66cf0847d', class: this.getAccordionClasses() }, ...(_a = this.accordions) === null || _a === void 0 ? void 0 : _a.map((accordion, index) => this.getAccordionItem(accordion, index))));
    }
