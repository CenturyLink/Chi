describe('Dropdown', function () {
  before(() => {
    cy.visit('tests/lumen/js/dropdown.html');
  ...
  describe('Open and closing functionality test for dropdown base', function () {
    ...
    it('Dropdown menu should close when dropdown trigger is clicked twice', () => {
      cy.get('[data-cy="dropdown-1"]').click().find('+.chi-dropdown__menu').should('be.not.visible');
    });
  });
  ...
  describe('Open and closing functionality test for dropdown target', function () {
    ...
    it('Dropdown menu should close when dropdown trigger is clicked', () => {
      cy.get('[data-cy="dropdown-2"]').click().find('++.chi-dropdown__menu').should('be.not.visible');
    });
  });
  ...
  describe('Open and closing functionality test for animated dropdown', function () {
    ...
    it('Dropdown menu should close when dropdown trigger is clicked twice', () => {
      cy.get('[data-cy="dropdown-animate"]').click().find('+.chi-dropdown__menu').should('be.not.visible');
    });
  });
    ...
    it('Dropdown Positioning should work in accordance', () => {
      this.chidata.floatingPositions.forEach((position) => {
        ...
        cy.get(getValue)
          ...
          .click()
          .then(() => {
            cy.get(getValue).find('+.chi-dropdown__menu').should('not.be.visible');
          });
      });
    });
  });
